    ...
    try {
      ...
      // Make.g:29:9: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '.' | '-' | '/' )+
      {
        ...
        do {
          ...
          if (((LA1_0 >= '-' && LA1_0 <= '9') || (LA1_0 >= 'A' && LA1_0 <= 'Z') || LA1_0 == '_' || (LA1_0 >= 'a'
              && LA1_0 <= 'z'))) {
            alt1 = 1;
          }
    ...
    try {
      ...
      // Make.g:37:9: '#' (~ ( '\\n' | '\\r' ) )* ( '\\r' )? '\\n'
      {
        ...
        do {
          ...
          if (((LA3_0 >= '\u0000' && LA3_0 <= '\t') || (LA3_0 >= '\u000B' && LA3_0 <= '\f') || (LA3_0 >= '\u000E'
              && LA3_0 <= '\uFFFF'))) {
            alt3 = 1;
          }
    ...
    public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
      ...
      switch (s) {
        ...
        case 1:
          ...
          if ((LA6_4 == '\t' || LA6_4 == ' ')) {
            s = 7;
          } else if (((LA6_4 >= '\u0000' && LA6_4 <= '\b') || (LA6_4 >= '\u000B' && LA6_4 <= '\u001F') || (LA6_4 >= '!'
              && LA6_4 <= '\uFFFF')) && ((getCharPositionInLine() == 0))) {
              s = 8;
          } else {
              s = 6;
          }
