  ...
  public Token nextToken() {
    while (true) {
      if (input.LA(1) == CharStream.EOF) {
        return new CommonToken(EOF, "end of input");
      }
      state.token = null;
  ...
  public final void mTITLE() throws RecognitionException {
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/trans/wiki/Wiki.g:36:9: {...}? => TAIL
      {
        ...
        TAIL1 = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, TAIL1Start43,
            getCharIndex() - 1);
        if (state.backtracking == 1) {
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/trans/wiki/Wiki.g:49:9: '@' (c=~ ( '|' | '@' ) )+ ( '|' (c=~ '@' )+ )? '@'
      {
        ...
        do {
          ...
          if (((LA2_0 >= '\u0000' && LA2_0 <= '?') || (LA2_0 >= 'A' && LA2_0 <= '{') || (LA2_0 >= '}'
              && LA2_0 <= '\uFFFF'))) {
            alt2 = 1;
          }
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/trans/wiki/Wiki.g:86:9: {...}? => ( '###' | '##' | '#' ) SEC_TAIL
      {
        ...
        if ((LA7_0 == '#')) {
          ...
          if ((LA7_1 == '#')) {
            ...
            if ((LA7_2 == '#')) {
              alt7 = 1;
            } else if (((LA7_2 >= '\u0000' && LA7_2 <= '\t') || (LA7_2 >= '\u000B' && LA7_2 <= '\"') || (LA7_2 >= '$'
                && LA7_2 <= '\uFFFF'))) {
              alt7 = 2;
            } else {
              if (state.backtracking > 0) {
          ...
          } else if (((LA7_1 >= '\u0000' && LA7_1 <= '\t') || (LA7_1 >= '\u000B' && LA7_1 <= '\"') || (LA7_1 >= '$'
              && LA7_1 <= '\uFFFF'))) {
            alt7 = 3;
          } else {
            if (state.backtracking > 0) {
        ...
        SEC_TAIL2 = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, SEC_TAIL2Start582,
            getCharIndex() - 1);
        if (state.backtracking == 1) {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/trans/wiki/Wiki.g:111:9: ( TABLE_CONTENT )+
      {
        ...
        do {
          ...
          if ((LA10_0 == '[')) {
            ...
            alt10 = 1;
          } else if (((LA10_0 >= '\u0000' && LA10_0 <= ')') || (LA10_0 >= '+' && LA10_0 <= 'Z') || (LA10_0 >= '\\'
              && LA10_0 <= '^') || (LA10_0 >= '`' && LA10_0 <= '\uFFFF')) && ((!upcomingEndOfCol()))) {
            alt10 = 1;
          }
  ...
  public final void mTABLE_CONTENT() throws RecognitionException {
    try {
      ...
      if ((LA11_0 == '[')) {
        ...
        if (((LA11_2 >= '\u0000' && LA11_2 <= ')') || (LA11_2 >= '+' && LA11_2 <= '\uFFFF')) && ((
      ...
      } else if (((LA11_0 >= '\u0000' && LA11_0 <= ')') || (LA11_0 >= '+' && LA11_0 <= 'Z') || (LA11_0 >= '\\'
          && LA11_0 <= '^') || (LA11_0 >= '`' && LA11_0 <= '\uFFFF')) && ((!upcomingEndOfCol()))) {
        alt11 = 4;
      } else {
        if (state.backtracking > 0) {
          state.failed = true;
    ...
    public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
      ...
      switch (s) {
        case 0:
          ...
          if ((LA14_0 == '*')) {
            ...
            s = 3;
              ...
              && LA14_0 <= '?') || (LA14_0 >= 'A' && LA14_0 <= '^') || (LA14_0 >= '`' && LA14_0 <= '\uFFFF'))) {
            s = 4;
          } else if ((LA14_0 == '\n')) {
            s = 5;
          }
        ...
        case 1:
          ...
          input.rewind();
          s = -1;
          if (((synpred1_Wiki() && (getLine() == 1)))) {
            s = 6;
          } else if (((synpred2_Wiki() && (getCharPositionInLine() > 0)))) {
            s = 7;
          } else if (((synpred5_Wiki() && (getCharPositionInLine() == 0)))) {
            s = 8;
          } else if ((true)) {
            s = 9;
          }
