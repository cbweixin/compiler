...
/**
 * A simple dynamically-typed language that smacks of Python. This builds a tree, then we'll
 * interpret it with a tree grammar Build a convential symbol table while parsing.  Save symbol ptrs
 * in AST nodes.
 */
public class PieParser extends Parser {

  public static final String[] tokenNames = new String[]{
      "<invalid>", "<EOR>", "<DOWN>", "<UP>", "ARGS", "FIELDS", "BLOCK", "CALL", "IF", "ASSIGN",
      "PRINT", "WHILE", "RETURN", "DEF", "ADD", "SUB", "MUL", "EQ", "LT", "STRUCT", "DOT", "NEW",
      "ID", "NL", "INT", "CHAR", "FLOAT", "STRING", "LETTER", "WS", "SL_COMMENT", "'{'", "','",
      "'}'", "'('", "')'", "':'", "'else'"
  };
  ...
  public final PieParser.program_return program() throws RecognitionException {
    ...
    RewriteRuleSubtreeStream stream_statement = new RewriteRuleSubtreeStream(adaptor,
        "rule statement");
    RewriteRuleSubtreeStream stream_functionDefinition = new RewriteRuleSubtreeStream(adaptor,
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/interp/tree/Pie.g:26:4: ( functionDefinition | statement )+ EOF
      {
        ...
        do {
          ...
          if ((LA1_0 == DEF)) {
            alt1 = 1;
          } else if ((LA1_0 == IF || (LA1_0 >= PRINT && LA1_0 <= RETURN) || LA1_0 == STRUCT || (
              LA1_0 >= ID && LA1_0 <= NL))) {
            alt1 = 2;
          }
  ...
  public final PieParser.functionDefinition_return functionDefinition()
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/interp/tree/Pie.g:43:4: 'def' ID '(' ( vardef ( ',' vardef )* )? ')' slist
      {
        ...
        FunctionSymbol fs = new FunctionSymbol((ID12 != null ? ID12.getText() : null),
            currentScope);
  ...
  public final PieParser.slist_return slist() throws RecognitionException {
    ...
    try {
      ...
      if ((LA6_0 == 36)) {
        alt6 = 1;
      } else if ((LA6_0 == IF || (LA6_0 >= PRINT && LA6_0 <= RETURN) || LA6_0 == STRUCT || (
          LA6_0 >= ID && LA6_0 <= NL))) {
        alt6 = 2;
      } else {
      ...
      switch (alt6) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/interp/tree/Pie.g:61:4: ':' NL ( statement )+ '.' NL
        {
          ...
          do {
            ...
            if ((LA5_0 == IF || (LA5_0 >= PRINT && LA5_0 <= RETURN) || LA5_0 == STRUCT || (
                LA5_0 >= ID && LA5_0 <= NL))) {
              alt5 = 1;
            }
    ...
    try {
      ...
      switch (alt8) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/interp/tree/Pie.g:70:4: 'if' expr c= slist ( 'else' el= slist )?
        {
          ...
          // wildcard labels:
          retval.tree = root_0;
          RewriteRuleSubtreeStream stream_el = new RewriteRuleSubtreeStream(adaptor, "rule el",
  ...
  public final PieParser.call_return call() throws RecognitionException {
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/interp/tree/Pie.g:81:4: name= ID '(' ( expr ( ',' expr )* )? ')'
      {
        ...
        if (((LA10_0 >= NEW && LA10_0 <= ID) || (LA10_0 >= INT && LA10_0 <= STRING)
            || LA10_0 == 34)) {
          alt10 = 1;
        }
        switch (alt10) {
  ...
  public static final BitSet FOLLOW_functionDefinition_in_program124 = new BitSet(
      new long[]{0x0000000000C83D00L});
  public static final BitSet FOLLOW_statement_in_program128 = new BitSet(
      new long[]{0x0000000000C83D00L});
  public static final BitSet FOLLOW_EOF_in_program133 = new BitSet(new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_STRUCT_in_structDefinition162 = new BitSet(
      new long[]{0x0000000000400000L});
  public static final BitSet FOLLOW_ID_in_structDefinition166 = new BitSet(
      new long[]{0x0000000080000000L});
  public static final BitSet FOLLOW_31_in_structDefinition168 = new BitSet(
      new long[]{0x0000000000400000L});
  public static final BitSet FOLLOW_vardef_in_structDefinition180 = new BitSet(
      new long[]{0x0000000300000000L});
  public static final BitSet FOLLOW_32_in_structDefinition183 = new BitSet(
      new long[]{0x0000000000400000L});
  public static final BitSet FOLLOW_vardef_in_structDefinition185 = new BitSet(
      new long[]{0x0000000300000000L});
  public static final BitSet FOLLOW_33_in_structDefinition189 = new BitSet(
      new long[]{0x0000000000800000L});
  public static final BitSet FOLLOW_NL_in_structDefinition191 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_DEF_in_functionDefinition214 = new BitSet(
      new long[]{0x0000000000400000L});
  public static final BitSet FOLLOW_ID_in_functionDefinition216 = new BitSet(
      new long[]{0x0000000400000000L});
  public static final BitSet FOLLOW_34_in_functionDefinition231 = new BitSet(
      new long[]{0x0000000800400000L});
  public static final BitSet FOLLOW_vardef_in_functionDefinition234 = new BitSet(
      new long[]{0x0000000900000000L});
  public static final BitSet FOLLOW_32_in_functionDefinition237 = new BitSet(
      new long[]{0x0000000000400000L});
  public static final BitSet FOLLOW_vardef_in_functionDefinition239 = new BitSet(
      new long[]{0x0000000900000000L});
  public static final BitSet FOLLOW_35_in_functionDefinition246 = new BitSet(
      new long[]{0x0000001000C83D00L});
  public static final BitSet FOLLOW_slist_in_functionDefinition254 = new BitSet(
      new long[]{0x0000000000000002L});
  ...
  public static final BitSet FOLLOW_statement_in_slist278 = new BitSet(
      new long[]{0x0000000000D83D00L});
  ...
  public static final BitSet FOLLOW_statement_in_slist297 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_structDefinition_in_statement320 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_qid_in_statement325 = new BitSet(
      new long[]{0x0000000000000200L});
  public static final BitSet FOLLOW_ASSIGN_in_statement327 = new BitSet(
      new long[]{0x000000040F600000L});
  public static final BitSet FOLLOW_expr_in_statement329 = new BitSet(
      new long[]{0x0000000000800000L});
  public static final BitSet FOLLOW_NL_in_statement331 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_RETURN_in_statement349 = new BitSet(
      new long[]{0x000000040F600000L});
  public static final BitSet FOLLOW_expr_in_statement351 = new BitSet(
      new long[]{0x0000000000800000L});
  public static final BitSet FOLLOW_NL_in_statement353 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_PRINT_in_statement370 = new BitSet(
      new long[]{0x000000040F600000L});
  public static final BitSet FOLLOW_expr_in_statement372 = new BitSet(
      new long[]{0x0000000000800000L});
  public static final BitSet FOLLOW_NL_in_statement374 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_IF_in_statement391 = new BitSet(
      new long[]{0x000000040F600000L});
  public static final BitSet FOLLOW_expr_in_statement393 = new BitSet(
      new long[]{0x0000001000C83D00L});
  public static final BitSet FOLLOW_slist_in_statement397 = new BitSet(
      new long[]{0x0000002000000002L});
  public static final BitSet FOLLOW_37_in_statement400 = new BitSet(
      new long[]{0x0000001000C83D00L});
  public static final BitSet FOLLOW_slist_in_statement404 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_WHILE_in_statement426 = new BitSet(
      new long[]{0x000000040F600000L});
  public static final BitSet FOLLOW_expr_in_statement428 = new BitSet(
      new long[]{0x0000001000C83D00L});
  public static final BitSet FOLLOW_slist_in_statement430 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_call_in_statement447 = new BitSet(
      new long[]{0x0000000000800000L});
  public static final BitSet FOLLOW_NL_in_statement449 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_NL_in_statement463 = new BitSet(
      new long[]{0x0000000000000002L});
  ...
  public static final BitSet FOLLOW_addexpr_in_expr525 = new BitSet(
      new long[]{0x0000000000060002L});
  public static final BitSet FOLLOW_set_in_expr528 = new BitSet(new long[]{0x000000040F600000L});
  public static final BitSet FOLLOW_addexpr_in_expr535 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_mulexpr_in_addexpr547 = new BitSet(
      new long[]{0x000000000000C002L});
  public static final BitSet FOLLOW_set_in_addexpr550 = new BitSet(new long[]{0x000000040F600000L});
  public static final BitSet FOLLOW_mulexpr_in_addexpr557 = new BitSet(
      new long[]{0x000000000000C002L});
  public static final BitSet FOLLOW_atom_in_mulexpr571 = new BitSet(
      new long[]{0x0000000000010002L});
  public static final BitSet FOLLOW_MUL_in_mulexpr574 = new BitSet(new long[]{0x000000040F600000L});
  public static final BitSet FOLLOW_atom_in_mulexpr577 = new BitSet(
      new long[]{0x0000000000010002L});
  ...
  public static final BitSet FOLLOW_instance_in_atom648 = new BitSet(
      new long[]{0x0000000000000002L});
  ...
  public static final BitSet FOLLOW_NEW_in_instance677 = new BitSet(
      new long[]{0x0000000000400000L});
