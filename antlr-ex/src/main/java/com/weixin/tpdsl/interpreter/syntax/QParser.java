...
public class QParser extends Parser {
  ...
  public static final String[] tokenNames = new String[]{
      "<invalid>", "<EOR>", "<DOWN>", "<UP>", "ID", "INT", "STRING", "COMMENT", "WS", "'print'",
      "';'", "'create'", "'table'", "'('", "'primary'", "'key'", "','", "')'", "'='", "'insert'",
      "'into'", "'set'", "'select'", "'from'", "'where'"
  };
  ...
  public static final BitSet FOLLOW_setFields_in_insert210 = new BitSet(
      new long[]{0x0000000000000400L});
  public static final BitSet FOLLOW_10_in_insert213 = new BitSet(new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_set_in_setFields257 = new BitSet(
      new long[]{0x0000000000010002L});
  public static final BitSet FOLLOW_16_in_setFields261 = new BitSet(
      new long[]{0x0000000000000010L});
  public static final BitSet FOLLOW_set_in_setFields263 = new BitSet(
      new long[]{0x0000000000010002L});
  ...
  public String[] getTokenNames() {
    return QParser.tokenNames;
  }

  @Override
  public String getGrammarFileName() {
    return "/Users/parrt/research/book/TPDSL/Book/code/interp/syntax/Q.g";
  }
  ...
  public final void table() throws RecognitionException {
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/interp/syntax/Q.g:27:9: 'create' 'table' tbl= ID '(' 'primary' 'key' key= ID ( ',' columns+= ID )+ ')' ';'
      {
        ...
        interp
            .createTable((tbl != null ? tbl.getText() : null), (key != null ? key.getText() : null),
                list_columns);
  ...
  public final Object query() throws RecognitionException {
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/interp/syntax/Q.g:55:9: 'select' columns+= ID ( ',' columns+= ID )* 'from' tbl= ID ( 'where' key= ID '=' expr | )
      {
        ...
        if ((LA6_0 == 24)) {
          alt6 = 1;
        } else if ((LA6_0 == EOF || LA6_0 == ID || (LA6_0 >= 9 && LA6_0 <= 11) || LA6_0 == 16
            || LA6_0 == 19 || LA6_0 == 22)) {
          alt6 = 2;
        } else {
          NoViableAltException nvae =
        ...
        switch (alt6) {
            ...
            // /Users/parrt/research/book/TPDSL/Book/code/interp/syntax/Q.g:56:13: 'where' key= ID '=' expr
          {
            ...
            value = interp.select((tbl != null ? tbl.getText() : null), list_columns,
                (key != null ? key.getText() : null), expr8);
