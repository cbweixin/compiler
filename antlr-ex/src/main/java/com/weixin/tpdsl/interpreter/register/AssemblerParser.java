...
/**
 * A generic bytecode assembler whose instructions take 0..3 operands. Instruction set is dictated
 * externally with a String[].  Implement specifics by subclassing and defining gen() methods.
 * Comments start with ';' and all instructions end with '\n'.  Handles both register (rN) and
 * stack-based assembly instructions.  Labels are "ID:".  "main:" label is where we start execution.
 * Use .globals and .def for global data and function definitions, respectively.
 */
public class AssemblerParser extends Parser {

  public static final String[] tokenNames = new String[]{
      "<invalid>", "<EOR>", "<DOWN>", "<UP>", "NEWLINE", "INT", "ID", "REG", "FUNC", "CHAR",
      "STRING", "FLOAT", "LETTER", "STR_CHARS", "WS", "'.globals'", "'.def'", "':'", "'args'",
      "'='", "','", "'locals'"
  };
  ...
  public final void functionDeclaration() throws RecognitionException {
    ...
    try {
      ...
      // Assembler.g:39:9: '.def' name= ID ':' 'args' '=' a= INT ',' 'locals' '=' lo= INT NEWLINE
      {
        ...
        defineFunction(name, (a != null ? Integer.valueOf(a.getText()) : 0),
            (lo != null ? Integer.valueOf(lo.getText()) : 0));
    ...
    try {
      ...
      switch (alt4) {
          ...
          // Assembler.g:49:9: ID a= operand ',' b= operand ',' c= operand NEWLINE
        {
          ...
          gen(ID6, (a != null ? ((Token) a.start) : null), (b != null ? ((Token) b.start) : null),
              (c != null ? ((Token) c.start) : null));
  ...
  public static final BitSet FOLLOW_globals_in_program26 = new BitSet(
      new long[]{0x0000000000010050L});
  public static final BitSet FOLLOW_functionDeclaration_in_program39 = new BitSet(
      new long[]{0x0000000000010052L});
  public static final BitSet FOLLOW_instr_in_program43 = new BitSet(
      new long[]{0x0000000000010052L});
  public static final BitSet FOLLOW_label_in_program47 = new BitSet(
      new long[]{0x0000000000010052L});
  public static final BitSet FOLLOW_NEWLINE_in_program51 = new BitSet(
      new long[]{0x0000000000010052L});
  public static final BitSet FOLLOW_NEWLINE_in_globals82 = new BitSet(
  ...
  public static final BitSet FOLLOW_NEWLINE_in_globals89 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_16_in_functionDeclaration109 = new BitSet(
      new long[]{0x0000000000000040L});
  public static final BitSet FOLLOW_ID_in_functionDeclaration113 = new BitSet(
      new long[]{0x0000000000020000L});
  public static final BitSet FOLLOW_17_in_functionDeclaration115 = new BitSet(
      new long[]{0x0000000000040000L});
  public static final BitSet FOLLOW_18_in_functionDeclaration117 = new BitSet(
      new long[]{0x0000000000080000L});
  public static final BitSet FOLLOW_19_in_functionDeclaration119 = new BitSet(
      new long[]{0x0000000000000020L});
  public static final BitSet FOLLOW_INT_in_functionDeclaration123 = new BitSet(
      new long[]{0x0000000000100000L});
  public static final BitSet FOLLOW_20_in_functionDeclaration125 = new BitSet(
      new long[]{0x0000000000200000L});
  public static final BitSet FOLLOW_21_in_functionDeclaration127 = new BitSet(
      new long[]{0x0000000000080000L});
  public static final BitSet FOLLOW_19_in_functionDeclaration129 = new BitSet(
      new long[]{0x0000000000000020L});
  public static final BitSet FOLLOW_INT_in_functionDeclaration133 = new BitSet(
      new long[]{0x0000000000000010L});
  public static final BitSet FOLLOW_NEWLINE_in_functionDeclaration135 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_ID_in_instr166 = new BitSet(new long[]{0x0000000000000010L});
  public static final BitSet FOLLOW_NEWLINE_in_instr168 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_ID_in_instr204 = new BitSet(new long[]{0x0000000000000FE0L});
  public static final BitSet FOLLOW_operand_in_instr206 = new BitSet(
      new long[]{0x0000000000000010L});
  public static final BitSet FOLLOW_NEWLINE_in_instr208 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_ID_in_instr236 = new BitSet(new long[]{0x0000000000000FE0L});
  public static final BitSet FOLLOW_operand_in_instr240 = new BitSet(
      new long[]{0x0000000000100000L});
  public static final BitSet FOLLOW_20_in_instr242 = new BitSet(new long[]{0x0000000000000FE0L});
  public static final BitSet FOLLOW_operand_in_instr246 = new BitSet(
      new long[]{0x0000000000000010L});
  public static final BitSet FOLLOW_NEWLINE_in_instr248 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_ID_in_instr260 = new BitSet(new long[]{0x0000000000000FE0L});
  public static final BitSet FOLLOW_operand_in_instr264 = new BitSet(
      new long[]{0x0000000000100000L});
  public static final BitSet FOLLOW_20_in_instr266 = new BitSet(new long[]{0x0000000000000FE0L});
  public static final BitSet FOLLOW_operand_in_instr270 = new BitSet(
      new long[]{0x0000000000100000L});
  public static final BitSet FOLLOW_20_in_instr272 = new BitSet(new long[]{0x0000000000000FE0L});
  public static final BitSet FOLLOW_operand_in_instr276 = new BitSet(
      new long[]{0x0000000000000010L});
  public static final BitSet FOLLOW_NEWLINE_in_instr278 = new BitSet(
      new long[]{0x0000000000000002L});
