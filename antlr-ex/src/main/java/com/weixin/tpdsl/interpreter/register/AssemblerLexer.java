    ...
    try {
      ...
      // Assembler.g:73:9: LETTER ( LETTER | '0' .. '9' )*
      {
        ...
        do {
          ...
          if (((LA1_0 >= '0' && LA1_0 <= '9') || (LA1_0 >= 'A' && LA1_0 <= 'Z') || (LA1_0 >= 'a'
              && LA1_0 <= 'z'))) {
            alt1 = 1;
          }
  ...
  public final void mFUNC() throws RecognitionException {
    try {
      ...
      // Assembler.g:75:9: ID '()'
      {
        ...
        mID();
        ID1 = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, ID1Start109,
            getCharIndex() - 1);
        match("()");
  ...
  public final void mSTRING() throws RecognitionException {
    try {
      ...
      // Assembler.g:86:9: '\\\"' STR_CHARS '\\\"'
      {
        ...
        mSTR_CHARS();
        STR_CHARS2 = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL,
            STR_CHARS2Start193, getCharIndex() - 1);
        match('\"');
