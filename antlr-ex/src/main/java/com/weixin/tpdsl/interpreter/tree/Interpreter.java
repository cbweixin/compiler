...
public class Interpreter {
  ...
  // the AST represents our code memory
  PieAST root;
  TokenRewriteStream tokens;
  // lexer/parser are part of the processor
  PieLexer lex;
  PieParser parser;
  ...
  public Object exec(PieAST t) {
    try {
      switch (t.getType()) {
        ...
        case PieParser.CHAR:
          return new Character(t.getText().charAt(1));
  ...
  public Object call(PieAST t) {
    ...
    // args compatible?
    if (fs.formalArgs == null && argCount > 0 ||
  ...
  public void ifstat(PieAST t) {
    ...
    PieAST elseCodeStart = null;
      if (t.getChildCount() == 3) {
          elseCodeStart = (PieAST) t.getChild(2);
      }
    Boolean c = (Boolean) exec(condStart);
