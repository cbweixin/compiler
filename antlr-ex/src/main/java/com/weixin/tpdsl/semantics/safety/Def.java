...
public class Def extends TreeFilter {
  ...
  public String getGrammarFileName() {
    return "/Users/parrt/research/book/TPDSL/Book/code/semantics/safety/Def.g";
  }
  ...
  public final void enterStruct() throws RecognitionException {
    ...
    try {
      ...
      {
        match(input, 23, FOLLOW_23_in_enterStruct218);
          if (state.failed) {
              return;
          }
        ...
        ID1 = (CymbolAST) match(input, ID, FOLLOW_ID_in_enterStruct220);
          if (state.failed) {
              return;
          }
  ...
  public final void exitStruct() throws RecognitionException {
    try {
      ...
      {
        match(input, 23, FOLLOW_23_in_exitStruct252);
          if (state.failed) {
              return;
          }
        if (state.backtracking == 1) {
  ...
  public final void enterMethod() throws RecognitionException {
    ...
    try {
      ...
      {
        match(input, METHOD_DECL, FOLLOW_METHOD_DECL_in_enterMethod283);
          if (state.failed) {
              return;
          }
        ...
        ID2 = (CymbolAST) match(input, ID, FOLLOW_ID_in_enterMethod287);
          if (state.failed) {
              return;
          }
        ...
        if (state.backtracking == 1) {
          ...
          MethodSymbol ms = new MethodSymbol((ID2 != null ? ID2.getText() : null), type3,
              currentScope);
          currentMethod = ms;
  ...
  public final Def.ret_return ret() throws RecognitionException {
    ...
    try {
      ...
      {
        match(input, 38, FOLLOW_38_in_ret320);
          if (state.failed) {
              return retval;
          }
  ...
  public final void exitMethod() throws RecognitionException {
    try {
      ...
      {
        match(input, METHOD_DECL, FOLLOW_METHOD_DECL_in_exitMethod348);
          if (state.failed) {
              return;
          }
        if (state.backtracking == 1) {
  ...
  public final void atoms() throws RecognitionException {
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/semantics/safety/Def.g:99:8: {...}? ID
      {
        ...
        match(input, ID, FOLLOW_ID_in_atoms388);
          if (state.failed) {
              return;
          }
        if (state.backtracking == 1) {
  ...
  public final void varDeclaration() throws RecognitionException {
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/semantics/safety/Def.g:106:9: ^( ( FIELD_DECL | VAR_DECL | ARG_DECL ) type ID ( . )? )
      {
        ...
        ID4 = (CymbolAST) match(input, ID, FOLLOW_ID_in_varDeclaration430);
          if (state.failed) {
              return;
          }
  ...
  public final Type type() throws RecognitionException {
    ...
    try {
      ...
      switch (alt6) {
        ...
        {
          match(input, 27, FOLLOW_27_in_type471);
            if (state.failed) {
                return type;
            }
  ...
  public static final BitSet FOLLOW_BLOCK_in_exitBlock187 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_23_in_enterStruct218 = new BitSet(
      new long[]{0x0000000000000004L});
  public static final BitSet FOLLOW_ID_in_enterStruct220 = new BitSet(
      new long[]{0x007FFFFFFFFFFFF0L});
  public static final BitSet FOLLOW_23_in_exitStruct252 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_METHOD_DECL_in_enterMethod283 = new BitSet(
      new long[]{0x0000000000000004L});
  public static final BitSet FOLLOW_type_in_enterMethod285 = new BitSet(
      new long[]{0x0000000000010000L});
  public static final BitSet FOLLOW_ID_in_enterMethod287 = new BitSet(
      new long[]{0x007FFFFFFFFFFFF8L});
  public static final BitSet FOLLOW_38_in_ret320 = new BitSet(new long[]{0x0000000000000004L});
  public static final BitSet FOLLOW_METHOD_DECL_in_exitMethod348 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_ID_in_atoms388 = new BitSet(new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_set_in_varDeclaration420 = new BitSet(
      new long[]{0x0000000000000004L});
  public static final BitSet FOLLOW_type_in_varDeclaration428 = new BitSet(
      new long[]{0x0000000000010000L});
  public static final BitSet FOLLOW_ID_in_varDeclaration430 = new BitSet(
      new long[]{0x007FFFFFFFFFFFF8L});
  public static final BitSet FOLLOW_27_in_type471 = new BitSet(new long[]{0x0000000000000004L});
  public static final BitSet FOLLOW_typeElement_in_type473 = new BitSet(
      new long[]{0x0000000000000008L});
  public static final BitSet FOLLOW_typeElement_in_type486 = new BitSet(
      new long[]{0x0000000000000002L});
