...
public class CymbolParser extends Parser {
  ...
  public static final String[] tokenNames = new String[]{
      ...
      "FIELD_DECL", "CALL", "ELIST", "EXPR", "UNARY_MINUS", "UNARY_NOT", "ASSIGN", "INDEX", "ID",
      "INT", "FLOAT", "CHAR", "LETTER", "WS", "SL_COMMENT", "'struct'", "'{'", "'}'", "';'", "'[]'",
      "'('", "')'", "','", "'float'", "'int'", "'char'", "'boolean'", "'void'", "'if'", "'else'",
      "'return'", "'!='", "'=='", "'<'", "'>'", "'<='", "'>='", "'+'", "'-'", "'*'", "'/'", "'!'",
      "'['", "']'", "'.'", "'true'", "'false'"
  };
  ...
  public String getGrammarFileName() {
    return "/Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g";
  }
              ...
              // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:26:5: structDeclaration
            {
              ...
              state._fsp--;
                ...
                if (state.backtracking == 0) {
                    adaptor.addChild(root_0, structDeclaration1.getTree());
                }
  ...
  public final CymbolParser.structDeclaration_return structDeclaration()
    ...
    RewriteRuleSubtreeStream stream_structMember = new RewriteRuleSubtreeStream(adaptor,
        "rule structMember");
    try {
      ...
      {
        string_literal4 = (Token) match(input, 23, FOLLOW_23_in_structDeclaration191);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
        ...
        ID5 = (Token) match(input, ID, FOLLOW_ID_in_structDeclaration193);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
        ...
        char_literal6 = (Token) match(input, 24, FOLLOW_24_in_structDeclaration195);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
          ...
          switch (alt2) {
              ...
              // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:31:20: structMember
            {
              ...
              state._fsp--;
                ...
                if (state.backtracking == 0) {
                    stream_structMember.add(structMember7.getTree());
                }
        ...
        char_literal8 = (Token) match(input, 25, FOLLOW_25_in_structDeclaration200);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
        ...
        char_literal9 = (Token) match(input, 26, FOLLOW_26_in_structDeclaration202);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
    ...
    try {
      ...
      switch (alt3) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:35:4: type ID ';'
        {
          ...
          ID11 = (Token) match(input, ID, FOLLOW_ID_in_structMember228);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          char_literal12 = (Token) match(input, 26, FOLLOW_26_in_structMember230);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
            ...
            // 35:18: -> ^( FIELD_DECL type ID )
            {
              // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:35:21: ^( FIELD_DECL type ID )
              {
                ...
                root_1 = (CymbolAST) adaptor
                    .becomeRoot((CymbolAST) adaptor.create(FIELD_DECL, "FIELD_DECL"), root_1);
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:36:4: type ID '[]' ';'
        {
          ...
          ID14 = (Token) match(input, ID, FOLLOW_ID_in_structMember249);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          string_literal15 = (Token) match(input, 27, FOLLOW_27_in_structMember251);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          char_literal16 = (Token) match(input, 26, FOLLOW_26_in_structMember253);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:37:4: structDeclaration
        {
          ...
          state._fsp--;
            ...
            if (state.backtracking == 0) {
                adaptor.addChild(root_0, structDeclaration17.getTree());
            }
  ...
  public final CymbolParser.methodDeclaration_return methodDeclaration()
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:42:9: type ID '(' ( formalParameters )? ')' block
      {
        ...
        ID19 = (Token) match(input, ID, FOLLOW_ID_in_methodDeclaration291);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
        ...
        char_literal20 = (Token) match(input, 28, FOLLOW_28_in_methodDeclaration293);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
        ...
        switch (alt4) {
            ...
            // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:42:21: formalParameters
          {
            ...
            state._fsp--;
              ...
              if (state.backtracking == 0) {
                  stream_formalParameters.add(formalParameters21.getTree());
              }
        ...
        char_literal22 = (Token) match(input, 29, FOLLOW_29_in_methodDeclaration298);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
        ...
        if (state.backtracking == 0) {
          ...
          // 43:9: -> ^( METHOD_DECL type ID ( formalParameters )? block )
          {
            // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:43:12: ^( METHOD_DECL type ID ( formalParameters )? block )
            {
              CymbolAST root_1 = (CymbolAST) adaptor.nil();
              root_1 = (CymbolAST) adaptor
                  .becomeRoot((CymbolAST) adaptor.create(METHOD_DECL, "METHOD_DECL"), root_1);
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:48:9: parameter ( ',' parameter )*
      {
        ...
        state._fsp--;
          ...
          if (state.backtracking == 0) {
              stream_parameter.add(parameter24.getTree());
          }
        ...
        do {
          ...
          switch (alt5) {
            ...
            {
              char_literal25 = (Token) match(input, 30, FOLLOW_30_in_formalParameters346);
                if (state.failed) {
                    return retval;
                }
                if (state.backtracking == 0) {
              ...
              state._fsp--;
                ...
                if (state.backtracking == 0) {
                    stream_parameter.add(parameter26.getTree());
                }
    ...
    try {
      ...
      switch (alt6) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:52:4: type ID
        {
          ...
          ID28 = (Token) match(input, ID, FOLLOW_ID_in_parameter375);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          if (state.backtracking == 0) {
            ...
            // 52:14: -> ^( ARG_DECL type ID )
            {
              // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:52:17: ^( ARG_DECL type ID )
              {
                CymbolAST root_1 = (CymbolAST) adaptor.nil();
                root_1 = (CymbolAST) adaptor
                    .becomeRoot((CymbolAST) adaptor.create(ARG_DECL, "ARG_DECL"), root_1);
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:53:4: type ID '[]'
        {
          ...
          ID30 = (Token) match(input, ID, FOLLOW_ID_in_parameter394);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          string_literal31 = (Token) match(input, 27, FOLLOW_27_in_parameter396);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
                stream_27.add(string_literal31);
            }
  ...
  public final CymbolParser.type_return type() throws RecognitionException {
    ...
    try {
      ...
      switch (alt7) {
        ...
        {
          string_literal33 = (Token) match(input, 23, FOLLOW_23_in_type427);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
                stream_23.add(string_literal33);
            }

          ID34 = (Token) match(input, ID, FOLLOW_ID_in_type429);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:
      {
        ...
        if ((input.LA(1) >= 31 && input.LA(1) <= 35)) {
          input.consume();
            if (state.backtracking == 0) {
                adaptor.addChild(root_0, (CymbolAST) adaptor.create(set35));
            }
  ...
  public final CymbolParser.block_return block() throws RecognitionException {
    ...
    try {
      ...
      {
        char_literal36 = (Token) match(input, 24, FOLLOW_24_in_block500);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
        ...
        do {
          ...
          if (((LA8_0 >= ID && LA8_0 <= CHAR) || (LA8_0 >= 23 && LA8_0 <= 24) || LA8_0 == 28 || (
              LA8_0 >= 31 && LA8_0 <= 36) || LA8_0 == 38 || (LA8_0 >= 53 && LA8_0 <= 54))) {
            alt8 = 1;
          }
          ...
          switch (alt8) {
              ...
              // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:70:13: statement
            {
              ...
              state._fsp--;
                ...
                if (state.backtracking == 0) {
                    stream_statement.add(statement37.getTree());
                }
        ...
        char_literal38 = (Token) match(input, 25, FOLLOW_25_in_block505);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
        ...
        if (state.backtracking == 0) {
          ...
          // 70:28: -> ^( BLOCK ( statement )* )
          {
            // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:70:31: ^( BLOCK ( statement )* )
            {
              CymbolAST root_1 = (CymbolAST) adaptor.nil();
              root_1 = (CymbolAST) adaptor
                  .becomeRoot((CymbolAST) adaptor.create(BLOCK, "BLOCK"), root_1);
    ...
    try {
      ...
      switch (alt11) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:76:9: type ID ( '=' expression )? ';'
        {
          ...
          ID40 = (Token) match(input, ID, FOLLOW_ID_in_varDeclaration537);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          switch (alt9) {
            ...
            {
              char_literal41 = (Token) match(input, ASSIGN, FOLLOW_ASSIGN_in_varDeclaration540);
                if (state.failed) {
                    return retval;
                }
                if (state.backtracking == 0) {
                    stream_ASSIGN.add(char_literal41);
                }
          ...
          char_literal43 = (Token) match(input, 26, FOLLOW_26_in_varDeclaration546);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          if (state.backtracking == 0) {
            ...
            // 76:43: -> ^( VAR_DECL type ID ( expression )? )
            {
              // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:76:46: ^( VAR_DECL type ID ( expression )? )
              {
                CymbolAST root_1 = (CymbolAST) adaptor.nil();
                root_1 = (CymbolAST) adaptor
                    .becomeRoot((CymbolAST) adaptor.create(VAR_DECL, "VAR_DECL"), root_1);
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:77:7: type ID '[]' ( '=' expression )? ';'
        {
          ...
          ID45 = (Token) match(input, ID, FOLLOW_ID_in_varDeclaration573);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          string_literal46 = (Token) match(input, 27, FOLLOW_27_in_varDeclaration575);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
                stream_27.add(string_literal46);
            }
          ...
          switch (alt10) {
            ...
            {
              char_literal47 = (Token) match(input, ASSIGN, FOLLOW_ASSIGN_in_varDeclaration578);
                if (state.failed) {
                    return retval;
                }
                if (state.backtracking == 0) {
                    stream_ASSIGN.add(char_literal47);
                }
          ...
          char_literal49 = (Token) match(input, 26, FOLLOW_26_in_varDeclaration584);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
      ...
      switch (alt14) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:84:7: structDeclaration
        {
          ...
          state._fsp--;
            ...
            if (state.backtracking == 0) {
                adaptor.addChild(root_0, structDeclaration51.getTree());
            }
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:85:7: varDeclaration
        {
          ...
          state._fsp--;
            ...
            if (state.backtracking == 0) {
                adaptor.addChild(root_0, varDeclaration52.getTree());
            }
        ...
        {
          string_literal53 = (Token) match(input, 36, FOLLOW_36_in_statement650);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
                stream_36.add(string_literal53);
            }

          char_literal54 = (Token) match(input, 28, FOLLOW_28_in_statement652);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          char_literal56 = (Token) match(input, 29, FOLLOW_29_in_statement656);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
                stream_29.add(char_literal56);
            }
          ...
          switch (alt12) {
            ...
            {
              string_literal57 = (Token) match(input, 37, FOLLOW_37_in_statement663);
                if (state.failed) {
                    return retval;
                }
                if (state.backtracking == 0) {
        ...
        {
          string_literal58 = (Token) match(input, 38, FOLLOW_38_in_statement699);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          if (((LA13_0 >= ID && LA13_0 <= CHAR) || LA13_0 == 28 || LA13_0 == 46 || LA13_0 == 49 || (
              LA13_0 >= 53 && LA13_0 <= 54))) {
            alt13 = 1;
          }
          switch (alt13) {
          ...
          char_literal60 = (Token) match(input, 26, FOLLOW_26_in_statement704);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:89:7: lhs '=' expression ';'
        {
          ...
          state._fsp--;
            ...
            if (state.backtracking == 0) {
                stream_lhs.add(lhs61.getTree());
            }
          char_literal62 = (Token) match(input, ASSIGN, FOLLOW_ASSIGN_in_statement723);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
                stream_ASSIGN.add(char_literal62);
            }
          ...
          char_literal64 = (Token) match(input, 26, FOLLOW_26_in_statement727);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:90:9: a= postfixExpression ';'
        {
          ...
          char_literal65 = (Token) match(input, 26, FOLLOW_26_in_statement751);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          if (state.backtracking == 0) {
            ...
            // 91:7: -> ^( EXPR postfixExpression )
            {
              // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:91:10: ^( EXPR postfixExpression )
              {
                CymbolAST root_1 = (CymbolAST) adaptor.nil();
                root_1 = (CymbolAST) adaptor
                    .becomeRoot((CymbolAST) adaptor.create(EXPR, "EXPR"), root_1);
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:94:7: postfixExpression
      {
        ...
        state._fsp--;
          ...
          if (state.backtracking == 0) {
              stream_postfixExpression.add(postfixExpression66.getTree());
          }
  ...
  public final CymbolParser.expressionList_return expressionList() throws RecognitionException {
    ...
    try {
      ...
      if (((LA16_0 >= ID && LA16_0 <= CHAR) || LA16_0 == 28 || LA16_0 == 46 || LA16_0 == 49 || (
          LA16_0 >= 53 && LA16_0 <= 54))) {
        alt16 = 1;
      } else if ((LA16_0 == 29)) {
        alt16 = 2;
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:98:9: expr ( ',' expr )*
        {
          ...
          do {
            ...
            switch (alt15) {
              ...
              {
                char_literal68 = (Token) match(input, 30, FOLLOW_30_in_expressionList807);
                  if (state.failed) {
                      return retval;
                  }
                  if (state.backtracking == 0) {
          ...
          if (state.backtracking == 0) {
            ...
            // 98:26: -> ^( ELIST ( expr )+ )
            {
              // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:98:29: ^( ELIST ( expr )+ )
              {
                CymbolAST root_1 = (CymbolAST) adaptor.nil();
                root_1 = (CymbolAST) adaptor
                    .becomeRoot((CymbolAST) adaptor.create(ELIST, "ELIST"), root_1);
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:106:7: equalityExpression
      {
        ...
        state._fsp--;
          ...
          if (state.backtracking == 0) {
              adaptor.addChild(root_0, equalityExpression71.getTree());
          }
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:110:4: relationalExpression ( ( '!=' | '==' ) relationalExpression )*
      {
        ...
        state._fsp--;
          ...
          if (state.backtracking == 0) {
              adaptor.addChild(root_0, relationalExpression72.getTree());
          }
          ...
          switch (alt18) {
              ...
              // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:110:26: ( '!=' | '==' ) relationalExpression
            {
              ...
              switch (alt17) {
                ...
                {
                  string_literal73 = (Token) match(input, 39, FOLLOW_39_in_equalityExpression887);
                    if (state.failed) {
                        return retval;
                    }
                  if (state.backtracking == 0) {
                ...
                {
                  string_literal74 = (Token) match(input, 40, FOLLOW_40_in_equalityExpression892);
                    if (state.failed) {
                        return retval;
                    }
                  if (state.backtracking == 0) {
              ...
              state._fsp--;
                ...
                if (state.backtracking == 0) {
                    adaptor.addChild(root_0, relationalExpression75.getTree());
                }
            ...
            switch (alt20) {
                ...
                // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:115:7: ( '<' | '>' | '<=' | '>=' ) additiveExpression
              {
                ...
                switch (alt19) {
                  ...
                  {
                    char_literal77 = (Token) match(input, 41, FOLLOW_41_in_relationalExpression919);
                      if (state.failed) {
                          return retval;
                      }
                    if (state.backtracking == 0) {
                  ...
                  {
                    char_literal78 = (Token) match(input, 42, FOLLOW_42_in_relationalExpression928);
                      if (state.failed) {
                          return retval;
                      }
                    if (state.backtracking == 0) {
                  ...
                  {
                    string_literal79 = (Token) match(input, 43,
                        FOLLOW_43_in_relationalExpression937);
                      if (state.failed) {
                          return retval;
                      }
                    if (state.backtracking == 0) {
                  ...
                  {
                    string_literal80 = (Token) match(input, 44,
                        FOLLOW_44_in_relationalExpression946);
                      if (state.failed) {
                          return retval;
                      }
                    if (state.backtracking == 0) {
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:126:4: multiplicativeExpression ( ( '+' | '-' ) multiplicativeExpression )*
      {
        ...
        state._fsp--;
          ...
          if (state.backtracking == 0) {
              adaptor.addChild(root_0, multiplicativeExpression82.getTree());
          }
          ...
          switch (alt22) {
              ...
              // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:126:30: ( '+' | '-' ) multiplicativeExpression
            {
              ...
              switch (alt21) {
                ...
                {
                  char_literal83 = (Token) match(input, 45, FOLLOW_45_in_additiveExpression984);
                    if (state.failed) {
                        return retval;
                    }
                  if (state.backtracking == 0) {
                ...
                {
                  char_literal84 = (Token) match(input, 46, FOLLOW_46_in_additiveExpression989);
                    if (state.failed) {
                        return retval;
                    }
                  if (state.backtracking == 0) {
              ...
              state._fsp--;
                ...
                if (state.backtracking == 0) {
                    adaptor.addChild(root_0, multiplicativeExpression85.getTree());
                }
          ...
          switch (alt24) {
              ...
              // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:130:21: ( '*' | '/' ) unaryExpression
            {
              ...
              switch (alt23) {
                ...
                {
                  char_literal87 = (Token) match(input, 47,
                      FOLLOW_47_in_multiplicativeExpression1010);
                    if (state.failed) {
                        return retval;
                    }
                  if (state.backtracking == 0) {
                ...
                {
                  char_literal88 = (Token) match(input, 48,
                      FOLLOW_48_in_multiplicativeExpression1015);
                    if (state.failed) {
                        return retval;
                    }
                  if (state.backtracking == 0) {
  ...
  public final CymbolParser.unaryExpression_return unaryExpression() throws RecognitionException {
    ...
    try {
      ...
      switch (alt25) {
        ...
        {
          op = (Token) match(input, 46, FOLLOW_46_in_unaryExpression1034);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          state._fsp--;
            ...
            if (state.backtracking == 0) {
                stream_unaryExpression.add(unaryExpression90.getTree());
            }
          ...
          if (state.backtracking == 0) {
            ...
            // 134:27: -> ^( UNARY_MINUS[$op] unaryExpression )
            {
              // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:134:30: ^( UNARY_MINUS[$op] unaryExpression )
              {
                CymbolAST root_1 = (CymbolAST) adaptor.nil();
                root_1 = (CymbolAST) adaptor
                    .becomeRoot((CymbolAST) adaptor.create(UNARY_MINUS, op), root_1);
        ...
        {
          op = (Token) match(input, 49, FOLLOW_49_in_unaryExpression1052);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          state._fsp--;
            ...
            if (state.backtracking == 0) {
                stream_unaryExpression.add(unaryExpression91.getTree());
            }
          ...
          if (state.backtracking == 0) {
            ...
            // 135:27: -> ^( UNARY_NOT[$op] unaryExpression )
            {
              // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:135:30: ^( UNARY_NOT[$op] unaryExpression )
              {
                CymbolAST root_1 = (CymbolAST) adaptor.nil();
                root_1 = (CymbolAST) adaptor
                    .becomeRoot((CymbolAST) adaptor.create(UNARY_NOT, op), root_1);
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:136:4: postfixExpression
        {
          ...
          state._fsp--;
            ...
            if (state.backtracking == 0) {
                adaptor.addChild(root_0, postfixExpression92.getTree());
            }
          ...
          switch (alt27) {
              ...
              // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:143:7: (r= '(' expressionList ')' | r= '[' expr ']' | r= '.' ID )
            {
              ...
              switch (alt26) {
                ...
                {
                  r = (Token) match(input, 28, FOLLOW_28_in_postfixExpression1104);
                    if (state.failed) {
                        return retval;
                    }
                  if (state.backtracking == 0) {
                  ...
                  state._fsp--;
                    ...
                    if (state.backtracking == 0) {
                        adaptor.addChild(root_0, expressionList94.getTree());
                    }
                  char_literal95 = (Token) match(input, 29, FOLLOW_29_in_postfixExpression1109);
                    if (state.failed) {
                        return retval;
                    }
                  if (state.backtracking == 0) {
                ...
                {
                  r = (Token) match(input, 50, FOLLOW_50_in_postfixExpression1124);
                    if (state.failed) {
                        return retval;
                    }
                  if (state.backtracking == 0) {
                  ...
                  char_literal97 = (Token) match(input, 51, FOLLOW_51_in_postfixExpression1129);
                    if (state.failed) {
                        return retval;
                    }
                  if (state.backtracking == 0) {
                ...
                {
                  r = (Token) match(input, 52, FOLLOW_52_in_postfixExpression1146);
                    if (state.failed) {
                        return retval;
                    }
                  if (state.backtracking == 0) {
                  ...
                  ID98 = (Token) match(input, ID, FOLLOW_ID_in_postfixExpression1149);
                    if (state.failed) {
                        return retval;
                    }
                  if (state.backtracking == 0) {
    ...
    try {
      ...
      switch (alt28) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:152:9: ID
        {
          ...
          ID99 = (Token) match(input, ID, FOLLOW_ID_in_primary1185);
            if (state.failed) {
                return retval;
            }
          if (state.backtracking == 0) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:153:9: INT
        {
          ...
          INT100 = (Token) match(input, INT, FOLLOW_INT_in_primary1195);
            if (state.failed) {
                return retval;
            }
          if (state.backtracking == 0) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:154:7: FLOAT
        {
          ...
          FLOAT101 = (Token) match(input, FLOAT, FOLLOW_FLOAT_in_primary1203);
            if (state.failed) {
                return retval;
            }
          if (state.backtracking == 0) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:155:7: CHAR
        {
          ...
          CHAR102 = (Token) match(input, CHAR, FOLLOW_CHAR_in_primary1211);
            if (state.failed) {
                return retval;
            }
          if (state.backtracking == 0) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:156:7: 'true'
        {
          ...
          string_literal103 = (Token) match(input, 53, FOLLOW_53_in_primary1219);
            if (state.failed) {
                return retval;
            }
          if (state.backtracking == 0) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:157:7: 'false'
        {
          ...
          string_literal104 = (Token) match(input, 54, FOLLOW_54_in_primary1227);
            if (state.failed) {
                return retval;
            }
          if (state.backtracking == 0) {
        ...
        {
          char_literal105 = (Token) match(input, 28, FOLLOW_28_in_primary1237);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
                stream_28.add(char_literal105);
            }
          ...
          char_literal107 = (Token) match(input, 29, FOLLOW_29_in_primary1241);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
                stream_29.add(char_literal107);
            }
  ...
  public final void synpred9_Cymbol_fragment() throws RecognitionException {
    ...
    // /Users/parrt/research/book/TPDSL/Book/code/semantics/types/Cymbol.g:89:7: lhs '=' expression ';'
    {
      ...
      match(input, ASSIGN, FOLLOW_ASSIGN_in_synpred9_Cymbol723);
        if (state.failed) {
            return;
        }
      ...
      match(input, 26, FOLLOW_26_in_synpred9_Cymbol727);
        if (state.failed) {
            return;
        }
  ...
  public static final BitSet FOLLOW_structDeclaration_in_compilationUnit164 = new BitSet(
      new long[]{0x0000000F80800002L});
  public static final BitSet FOLLOW_methodDeclaration_in_compilationUnit168 = new BitSet(
      new long[]{0x0000000F80800002L});
  public static final BitSet FOLLOW_varDeclaration_in_compilationUnit172 = new BitSet(
      new long[]{0x0000000F80800002L});
  public static final BitSet FOLLOW_23_in_structDeclaration191 = new BitSet(
      new long[]{0x0000000000010000L});
  public static final BitSet FOLLOW_ID_in_structDeclaration193 = new BitSet(
      new long[]{0x0000000001000000L});
  public static final BitSet FOLLOW_24_in_structDeclaration195 = new BitSet(
      new long[]{0x0000000F80800000L});
  public static final BitSet FOLLOW_structMember_in_structDeclaration197 = new BitSet(
      new long[]{0x0000000F82800000L});
  public static final BitSet FOLLOW_25_in_structDeclaration200 = new BitSet(
      new long[]{0x0000000004000000L});
  public static final BitSet FOLLOW_26_in_structDeclaration202 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_type_in_structMember226 = new BitSet(
      new long[]{0x0000000000010000L});
  public static final BitSet FOLLOW_ID_in_structMember228 = new BitSet(
      new long[]{0x0000000004000000L});
  public static final BitSet FOLLOW_26_in_structMember230 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_type_in_structMember247 = new BitSet(
      new long[]{0x0000000000010000L});
  public static final BitSet FOLLOW_ID_in_structMember249 = new BitSet(
      new long[]{0x0000000008000000L});
  public static final BitSet FOLLOW_27_in_structMember251 = new BitSet(
      new long[]{0x0000000004000000L});
  public static final BitSet FOLLOW_26_in_structMember253 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_structDeclaration_in_structMember272 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_type_in_methodDeclaration289 = new BitSet(
      new long[]{0x0000000000010000L});
  public static final BitSet FOLLOW_ID_in_methodDeclaration291 = new BitSet(
      new long[]{0x0000000010000000L});
  public static final BitSet FOLLOW_28_in_methodDeclaration293 = new BitSet(
      new long[]{0x0000000FA0800000L});
  public static final BitSet FOLLOW_formalParameters_in_methodDeclaration295 = new BitSet(
      new long[]{0x0000000020000000L});
  public static final BitSet FOLLOW_29_in_methodDeclaration298 = new BitSet(
      new long[]{0x0000000001000000L});
  public static final BitSet FOLLOW_block_in_methodDeclaration300 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_parameter_in_formalParameters343 = new BitSet(
      new long[]{0x0000000040000002L});
  public static final BitSet FOLLOW_30_in_formalParameters346 = new BitSet(
      new long[]{0x0000000F80800000L});
  public static final BitSet FOLLOW_parameter_in_formalParameters348 = new BitSet(
      new long[]{0x0000000040000002L});
  public static final BitSet FOLLOW_type_in_parameter373 = new BitSet(
      new long[]{0x0000000000010000L});
  public static final BitSet FOLLOW_ID_in_parameter375 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_type_in_parameter392 = new BitSet(
      new long[]{0x0000000000010000L});
  public static final BitSet FOLLOW_ID_in_parameter394 = new BitSet(
      new long[]{0x0000000008000000L});
  public static final BitSet FOLLOW_27_in_parameter396 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_primitiveType_in_type419 = new BitSet(
      new long[]{0x0000000000000002L});
  ...
  public static final BitSet FOLLOW_statement_in_block502 = new BitSet(
      new long[]{0x0060005F938F0000L});
  public static final BitSet FOLLOW_25_in_block505 = new BitSet(new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_type_in_varDeclaration535 = new BitSet(
      new long[]{0x0000000000010000L});
  public static final BitSet FOLLOW_ID_in_varDeclaration537 = new BitSet(
      new long[]{0x0000000004004000L});
  public static final BitSet FOLLOW_ASSIGN_in_varDeclaration540 = new BitSet(
      new long[]{0x00624000100F0000L});
  public static final BitSet FOLLOW_expression_in_varDeclaration542 = new BitSet(
      new long[]{0x0000000004000000L});
  public static final BitSet FOLLOW_26_in_varDeclaration546 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_type_in_varDeclaration571 = new BitSet(
      new long[]{0x0000000000010000L});
  public static final BitSet FOLLOW_ID_in_varDeclaration573 = new BitSet(
      new long[]{0x0000000008000000L});
  public static final BitSet FOLLOW_27_in_varDeclaration575 = new BitSet(
      new long[]{0x0000000004004000L});
  public static final BitSet FOLLOW_ASSIGN_in_varDeclaration578 = new BitSet(
      new long[]{0x00624000100F0000L});
  public static final BitSet FOLLOW_expression_in_varDeclaration580 = new BitSet(
      new long[]{0x0000000004000000L});
  public static final BitSet FOLLOW_26_in_varDeclaration584 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_block_in_statement626 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_structDeclaration_in_statement634 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_varDeclaration_in_statement642 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_36_in_statement650 = new BitSet(
      new long[]{0x0000000010000000L});
  public static final BitSet FOLLOW_28_in_statement652 = new BitSet(
      new long[]{0x00624000100F0000L});
  public static final BitSet FOLLOW_expression_in_statement654 = new BitSet(
      new long[]{0x0000000020000000L});
  public static final BitSet FOLLOW_29_in_statement656 = new BitSet(
      new long[]{0x0060005F918F0000L});
  public static final BitSet FOLLOW_statement_in_statement660 = new BitSet(
      new long[]{0x0000002000000002L});
  public static final BitSet FOLLOW_37_in_statement663 = new BitSet(
      new long[]{0x0060005F918F0000L});
  public static final BitSet FOLLOW_statement_in_statement667 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_38_in_statement699 = new BitSet(
      new long[]{0x00624000140F0000L});
  public static final BitSet FOLLOW_expression_in_statement701 = new BitSet(
      new long[]{0x0000000004000000L});
  public static final BitSet FOLLOW_26_in_statement704 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_lhs_in_statement721 = new BitSet(
      new long[]{0x0000000000004000L});
  public static final BitSet FOLLOW_ASSIGN_in_statement723 = new BitSet(
      new long[]{0x00624000100F0000L});
  public static final BitSet FOLLOW_expression_in_statement725 = new BitSet(
      new long[]{0x0000000004000000L});
  public static final BitSet FOLLOW_26_in_statement727 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_postfixExpression_in_statement749 = new BitSet(
      new long[]{0x0000000004000000L});
  public static final BitSet FOLLOW_26_in_statement751 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_postfixExpression_in_lhs779 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_expr_in_expressionList804 = new BitSet(
      new long[]{0x0000000040000002L});
  public static final BitSet FOLLOW_30_in_expressionList807 = new BitSet(
      new long[]{0x00624000100F0000L});
  public static final BitSet FOLLOW_expr_in_expressionList809 = new BitSet(
      new long[]{0x0000000040000002L});
  public static final BitSet FOLLOW_expr_in_expression851 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_equalityExpression_in_expr871 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_relationalExpression_in_equalityExpression883 = new BitSet(
      new long[]{0x0000018000000002L});
  public static final BitSet FOLLOW_39_in_equalityExpression887 = new BitSet(
      new long[]{0x00624000100F0000L});
  public static final BitSet FOLLOW_40_in_equalityExpression892 = new BitSet(
      new long[]{0x00624000100F0000L});
  public static final BitSet FOLLOW_relationalExpression_in_equalityExpression896 = new BitSet(
      new long[]{0x0000018000000002L});
  public static final BitSet FOLLOW_additiveExpression_in_relationalExpression909 = new BitSet(
      new long[]{0x00001E0000000002L});
  public static final BitSet FOLLOW_41_in_relationalExpression919 = new BitSet(
      new long[]{0x00624000100F0000L});
  public static final BitSet FOLLOW_42_in_relationalExpression928 = new BitSet(
      new long[]{0x00624000100F0000L});
  public static final BitSet FOLLOW_43_in_relationalExpression937 = new BitSet(
      new long[]{0x00624000100F0000L});
  public static final BitSet FOLLOW_44_in_relationalExpression946 = new BitSet(
      new long[]{0x00624000100F0000L});
  public static final BitSet FOLLOW_additiveExpression_in_relationalExpression959 = new BitSet(
      new long[]{0x00001E0000000002L});
  public static final BitSet FOLLOW_multiplicativeExpression_in_additiveExpression980 = new BitSet(
      new long[]{0x0000600000000002L});
  public static final BitSet FOLLOW_45_in_additiveExpression984 = new BitSet(
      new long[]{0x00624000100F0000L});
  public static final BitSet FOLLOW_46_in_additiveExpression989 = new BitSet(
      new long[]{0x00624000100F0000L});
  public static final BitSet FOLLOW_multiplicativeExpression_in_additiveExpression993 = new BitSet(
      new long[]{0x0000600000000002L});
  public static final BitSet FOLLOW_unaryExpression_in_multiplicativeExpression1006 = new BitSet(
      new long[]{0x0001800000000002L});
  public static final BitSet FOLLOW_47_in_multiplicativeExpression1010 = new BitSet(
      new long[]{0x00624000100F0000L});
  public static final BitSet FOLLOW_48_in_multiplicativeExpression1015 = new BitSet(
      new long[]{0x00624000100F0000L});
  public static final BitSet FOLLOW_unaryExpression_in_multiplicativeExpression1019 = new BitSet(
      new long[]{0x0001800000000002L});
  public static final BitSet FOLLOW_46_in_unaryExpression1034 = new BitSet(
      new long[]{0x00624000100F0000L});
  public static final BitSet FOLLOW_unaryExpression_in_unaryExpression1036 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_49_in_unaryExpression1052 = new BitSet(
      new long[]{0x00624000100F0000L});
  public static final BitSet FOLLOW_unaryExpression_in_unaryExpression1054 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_postfixExpression_in_unaryExpression1068 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_primary_in_postfixExpression1085 = new BitSet(
      new long[]{0x0014000010000002L});
  public static final BitSet FOLLOW_28_in_postfixExpression1104 = new BitSet(
      new long[]{0x00624000300F0000L});
  public static final BitSet FOLLOW_expressionList_in_postfixExpression1107 = new BitSet(
      new long[]{0x0000000020000000L});
  public static final BitSet FOLLOW_29_in_postfixExpression1109 = new BitSet(
      new long[]{0x0014000010000002L});
  public static final BitSet FOLLOW_50_in_postfixExpression1124 = new BitSet(
      new long[]{0x00624000100F0000L});
  public static final BitSet FOLLOW_expr_in_postfixExpression1127 = new BitSet(
      new long[]{0x0008000000000000L});
  public static final BitSet FOLLOW_51_in_postfixExpression1129 = new BitSet(
      new long[]{0x0014000010000002L});
  public static final BitSet FOLLOW_52_in_postfixExpression1146 = new BitSet(
      new long[]{0x0000000000010000L});
  public static final BitSet FOLLOW_ID_in_postfixExpression1149 = new BitSet(
      new long[]{0x0014000010000002L});
  public static final BitSet FOLLOW_ID_in_primary1185 = new BitSet(new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_INT_in_primary1195 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_FLOAT_in_primary1203 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_CHAR_in_primary1211 = new BitSet(
      new long[]{0x0000000000000002L});
  ...
  public static final BitSet FOLLOW_expression_in_primary1239 = new BitSet(
      new long[]{0x0000000020000000L});
  public static final BitSet FOLLOW_29_in_primary1241 = new BitSet(new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_structDeclaration_in_synpred5_Cymbol634 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_varDeclaration_in_synpred6_Cymbol642 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_lhs_in_synpred9_Cymbol721 = new BitSet(
      new long[]{0x0000000000004000L});
  public static final BitSet FOLLOW_ASSIGN_in_synpred9_Cymbol723 = new BitSet(
      new long[]{0x00624000100F0000L});
  public static final BitSet FOLLOW_expression_in_synpred9_Cymbol725 = new BitSet(
      new long[]{0x0000000004000000L});
  public static final BitSet FOLLOW_26_in_synpred9_Cymbol727 = new BitSet(
      new long[]{0x0000000000000002L});
