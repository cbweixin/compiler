...
public class PointerType extends Symbol implements Type {
  ...
  /**
   * Can we assign this type to destination type?  destType must be pointer and to same type unless
   * object ptr.  Then, we have to do a polymorphic check. [Ha! This method is a perfect example of
