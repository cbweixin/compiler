...
public class Def extends TreeFilter {
  ...
  public static final BitSet FOLLOW_enterMethod_in_topdown66 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_enterClass_in_topdown76 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_atoms_in_topdown86 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_varDeclaration_in_topdown96 = new BitSet(
      new long[]{0x0000000000000002L});
  ...
  public static final BitSet FOLLOW_exitMethod_in_bottomup135 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_exitClass_in_bottomup145 = new BitSet(
      new long[]{0x0000000000000002L});
  // $ANTLR end "topdown"
  ...
  public static final BitSet FOLLOW_26_in_enterClass218 = new BitSet(
      new long[]{0x0000000000000004L});
  // $ANTLR end "exitBlock"
  public static final BitSet FOLLOW_ID_in_enterClass222 = new BitSet(
      new long[]{0x07FFFFFFFFFFFFF0L});
  // $ANTLR end "enterClass"
  public static final BitSet FOLLOW_30_in_enterClass226 = new BitSet(
      new long[]{0x0000000000000004L});
  // $ANTLR end "exitClass"
  public static final BitSet FOLLOW_ID_in_enterClass230 = new BitSet(
      new long[]{0x0000000000000008L});
  // $ANTLR end "enterMethod"
  public static final BitSet FOLLOW_26_in_exitClass266 = new BitSet(
      new long[]{0x0000000000000002L});

    public static final BitSet FOLLOW_METHOD_DECL_in_enterMethod291 = new BitSet(
      new long[]{0x0000000000000004L});
  // $ANTLR end "ret"
  public static final BitSet FOLLOW_type_in_enterMethod293 = new BitSet(
      new long[]{0x0000000000080000L});
  // $ANTLR end "exitMethod"
  public static final BitSet FOLLOW_ID_in_enterMethod295 = new BitSet(
      new long[]{0x07FFFFFFFFFFFFF8L});
  // $ANTLR end "atoms"
  public static final BitSet FOLLOW_43_in_ret328 = new BitSet(new long[]{0x0000000000000004L});
  // $ANTLR end "varDeclaration"
  public static final BitSet FOLLOW_METHOD_DECL_in_exitMethod356 = new BitSet(
      new long[]{0x0000000000000002L});
  // $ANTLR end "type"
  ...
  // Delegated rules
  public static final BitSet FOLLOW_set_in_varDeclaration428 = new BitSet(
      new long[]{0x0000000000000004L});
  public static final BitSet FOLLOW_type_in_varDeclaration436 = new BitSet(
      new long[]{0x0000000000080000L});
  public static final BitSet FOLLOW_ID_in_varDeclaration438 = new BitSet(
      new long[]{0x07FFFFFFFFFFFFF8L});
  public static final BitSet FOLLOW_35_in_type480 = new BitSet(new long[]{0x0000000000000004L});
  public static final BitSet FOLLOW_typeElement_in_type482 = new BitSet(
      new long[]{0x0000000000000008L});
  public static final BitSet FOLLOW_typeElement_in_type496 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_set_in_typeElement0 = new BitSet(
      new long[]{0x0000000000000002L});
  SymbolTable symtab;
  Scope currentScope;
  ...
  public String getGrammarFileName() {
    return "/Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Def.g";
  }
  ...
  public final void enterClass() throws RecognitionException {
    ...
    try {
      ...
      {
        match(input, 26, FOLLOW_26_in_enterClass218);
          if (state.failed) {
              return;
          }
        ...
        name = (CymbolAST) match(input, ID, FOLLOW_ID_in_enterClass222);
          if (state.failed) {
              return;
          }
        ...
        switch (alt3) {
          ...
          {
            match(input, 30, FOLLOW_30_in_enterClass226);
              if (state.failed) {
                  return;
              }
            ...
            sup = (CymbolAST) match(input, ID, FOLLOW_ID_in_enterClass230);
              if (state.failed) {
                  return;
              }
        ...
        if (state.backtracking == 1) {
          ...
          if (sup != null) { // can only ref classes above in file
            superclass = (ClassSymbol) currentScope
                .resolve((sup != null ? sup.getText() : null)); // find superclass
  ...
  public final void exitClass() throws RecognitionException {
    try {
      ...
      {
        match(input, 26, FOLLOW_26_in_exitClass266);
          if (state.failed) {
              return;
          }
        if (state.backtracking == 1) {
  ...
  public final void enterMethod() throws RecognitionException {
    ...
    try {
      ...
      {
        match(input, METHOD_DECL, FOLLOW_METHOD_DECL_in_enterMethod291);
          if (state.failed) {
              return;
          }
        ...
        ID1 = (CymbolAST) match(input, ID, FOLLOW_ID_in_enterMethod295);
          if (state.failed) {
              return;
          }
        ...
        if (state.backtracking == 1) {
          ...
          MethodSymbol ms = new MethodSymbol((ID1 != null ? ID1.getText() : null), type2,
              currentScope);
          currentMethod = ms;
  ...
  public final Def.ret_return ret() throws RecognitionException {
    ...
    try {
      ...
      {
        match(input, 43, FOLLOW_43_in_ret328);
          if (state.failed) {
              return retval;
          }
  ...
  public final void exitMethod() throws RecognitionException {
    try {
      ...
      {
        match(input, METHOD_DECL, FOLLOW_METHOD_DECL_in_exitMethod356);
          if (state.failed) {
              return;
          }
        if (state.backtracking == 1) {
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Def.g:100:8: {...}? ID
      {
        if (!((t.hasAncestor(EXPR) || t.hasAncestor(ASSIGN)))) {
          ...
          throw new FailedPredicateException(input, "atoms",
              "t.hasAncestor(EXPR)||t.hasAncestor(ASSIGN)");
        }
        match(input, ID, FOLLOW_ID_in_atoms396);
          if (state.failed) {
              return;
          }
        if (state.backtracking == 1) {
  ...
  public final void varDeclaration() throws RecognitionException {
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Def.g:107:9: ^( ( FIELD_DECL | VAR_DECL | ARG_DECL ) type ID ( . )? )
      {
        ...
        ID3 = (CymbolAST) match(input, ID, FOLLOW_ID_in_varDeclaration438);
          if (state.failed) {
              return;
          }
  ...
  public final Type type() throws RecognitionException {
    ...
    try {
      ...
      switch (alt6) {
        ...
        {
          match(input, 35, FOLLOW_35_in_type480);
            if (state.failed) {
                return type;
            }
