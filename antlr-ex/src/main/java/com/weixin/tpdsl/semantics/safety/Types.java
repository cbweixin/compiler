...
public class Types extends TreeFilter {
  ...
  public final void ifstat() throws RecognitionException {
    ...
    try {
      ...
      {
        match(input, 36, FOLLOW_36_in_ifstat106);
          if (state.failed) {
              return;
          }
  ...
  public final void decl() throws RecognitionException {
    ...
    try {
      ...
      {
        match(input, VAR_DECL, FOLLOW_VAR_DECL_in_decl134);
          if (state.failed) {
              return;
          }
        ...
        ID1 = (CymbolAST) match(input, ID, FOLLOW_ID_in_decl138);
          if (state.failed) {
              return;
          }
  ...
  public final Types.ret_return ret() throws RecognitionException {
    ...
    try {
      ...
      {
        match(input, 38, FOLLOW_38_in_ret177);
          if (state.failed) {
              return retval;
          }
  ...
  public final void assignment() throws RecognitionException {
    ...
    try {
      ...
      {
        match(input, ASSIGN, FOLLOW_ASSIGN_in_assignment201);
          if (state.failed) {
              return;
          }
  ...
  public final void exprRoot() throws RecognitionException {
    ...
    try {
      ...
      {
        EXPR2 = (CymbolAST) match(input, EXPR, FOLLOW_EXPR_in_exprRoot235);
          if (state.failed) {
              return;
          }
  ...
  public final Types.expr_return expr() throws RecognitionException {
    ...
    try {
      ...
      switch (alt4) {
        ...
        {
          match(input, 53, FOLLOW_53_in_expr269);
            if (state.failed) {
                return retval;
            }
          if (state.backtracking == 1) {
        ...
        {
          match(input, 54, FOLLOW_54_in_expr286);
            if (state.failed) {
                return retval;
            }
          if (state.backtracking == 1) {
        ...
        {
          match(input, CHAR, FOLLOW_CHAR_in_expr302);
            if (state.failed) {
                return retval;
            }
          if (state.backtracking == 1) {
        ...
        {
          match(input, INT, FOLLOW_INT_in_expr321);
            if (state.failed) {
                return retval;
            }
          if (state.backtracking == 1) {
        ...
        {
          match(input, FLOAT, FOLLOW_FLOAT_in_expr341);
            if (state.failed) {
                return retval;
            }
          if (state.backtracking == 1) {
        ...
        {
          ID4 = (CymbolAST) match(input, ID, FOLLOW_ID_in_expr359);
            if (state.failed) {
                return retval;
            }
          if (state.backtracking == 1) {
            VariableSymbol s = (VariableSymbol) ID4.scope
                .resolve((ID4 != null ? ID4.getText() : null));
            ID4.symbol = s;
            retval.type = s.type;
          }
        ...
        {
          match(input, UNARY_MINUS, FOLLOW_UNARY_MINUS_in_expr372);
            if (state.failed) {
                return retval;
            }
        ...
        {
          match(input, UNARY_NOT, FOLLOW_UNARY_NOT_in_expr392);
            if (state.failed) {
                return retval;
            }
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/semantics/safety/Types.g:67:4: ( ^( bop a= expr b= expr ) | ^( relop a= expr b= expr ) | ^( eqop a= expr b= expr ) )
      {
        ...
        switch (alt5) {
            ...
            // /Users/parrt/research/book/TPDSL/Book/code/semantics/safety/Types.g:67:6: ^( bop a= expr b= expr )
          {
            ...
            if (state.backtracking == 1) {
              retval.type = symtab.bop((a != null ? ((CymbolAST) a.start) : null),
                  (b != null ? ((CymbolAST) b.start) : null));
            }
            ...
            // /Users/parrt/research/book/TPDSL/Book/code/semantics/safety/Types.g:68:5: ^( relop a= expr b= expr )
          {
            ...
            if (state.backtracking == 1) {
              retval.type = symtab.relop((a != null ? ((CymbolAST) a.start) : null),
                  (b != null ? ((CymbolAST) b.start) : null));
            }
            ...
            // /Users/parrt/research/book/TPDSL/Book/code/semantics/safety/Types.g:69:5: ^( eqop a= expr b= expr )
          {
            ...
            if (state.backtracking == 1) {
              retval.type = symtab.eqop((a != null ? ((CymbolAST) a.start) : null),
                  (b != null ? ((CymbolAST) b.start) : null));
            }
  ...
  public final Types.arrayRef_return arrayRef() throws RecognitionException {
    ...
    try {
      ...
      {
        match(input, INDEX, FOLLOW_INDEX_in_arrayRef567);
          if (state.failed) {
              return retval;
          }
        ...
        ID9 = (CymbolAST) match(input, ID, FOLLOW_ID_in_arrayRef569);
          if (state.failed) {
              return retval;
          }
        ...
        if (state.backtracking == 1) {
          ...
          retval.type = symtab
              .arrayIndex(ID9, (expr10 != null ? ((CymbolAST) expr10.start) : null));
          ((CymbolAST) retval.start).evalType = retval.type;
  ...
  public final Types.call_return call() throws RecognitionException {
    ...
    try {
      ...
      {
        match(input, CALL, FOLLOW_CALL_in_call597);
          if (state.failed) {
              return retval;
          }
        ...
        ID12 = (CymbolAST) match(input, ID, FOLLOW_ID_in_call599);
          if (state.failed) {
              return retval;
          }
        match(input, ELIST, FOLLOW_ELIST_in_call602);
          if (state.failed) {
              return retval;
          }
        ...
        if (input.LA(1) == Token.DOWN) {
          ...
          do {
            ...
            if ((LA6_0 == CALL || (LA6_0 >= UNARY_MINUS && LA6_0 <= UNARY_NOT) || (LA6_0 >= INDEX
                && LA6_0 <= CHAR) || (LA6_0 >= 39 && LA6_0 <= 48) || (LA6_0 >= 52
                && LA6_0 <= 54))) {
              alt6 = 1;
            }
  ...
  public final Types.member_return member() throws RecognitionException {
    ...
    try {
      ...
      {
        match(input, 52, FOLLOW_52_in_member634);
          if (state.failed) {
              return retval;
          }
        ...
        ID14 = (CymbolAST) match(input, ID, FOLLOW_ID_in_member638);
          if (state.failed) {
              return retval;
          }
  ...
  public static final BitSet FOLLOW_exprRoot_in_bottomup57 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_decl_in_bottomup65 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_ret_in_bottomup73 = new BitSet(new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_assignment_in_bottomup81 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_ifstat_in_bottomup89 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_36_in_ifstat106 = new BitSet(new long[]{0x0000000000000004L});
  public static final BitSet FOLLOW_VAR_DECL_in_decl134 = new BitSet(
  ...
  public static final BitSet FOLLOW_ASSIGN_in_assignment201 = new BitSet(
      new long[]{0x0000000000000004L});
  public static final BitSet FOLLOW_EXPR_in_exprRoot235 = new BitSet(
      new long[]{0x0000000000000004L});
  public static final BitSet FOLLOW_expr_in_exprRoot237 = new BitSet(
  ...
  public static final BitSet FOLLOW_UNARY_MINUS_in_expr372 = new BitSet(
      new long[]{0x0000000000000004L});
  public static final BitSet FOLLOW_expr_in_expr376 = new BitSet(new long[]{0x0000000000000008L});
  public static final BitSet FOLLOW_UNARY_NOT_in_expr392 = new BitSet(
      new long[]{0x0000000000000004L});
  ...
  public static final BitSet FOLLOW_arrayRef_in_expr430 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_call_in_expr445 = new BitSet(new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_binaryOps_in_expr464 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_bop_in_binaryOps494 = new BitSet(
      new long[]{0x0000000000000004L});
  public static final BitSet FOLLOW_expr_in_binaryOps498 = new BitSet(
      new long[]{0x0071FF80000FB200L});
  public static final BitSet FOLLOW_expr_in_binaryOps502 = new BitSet(
      new long[]{0x0000000000000008L});
  public static final BitSet FOLLOW_relop_in_binaryOps515 = new BitSet(
      new long[]{0x0000000000000004L});
  public static final BitSet FOLLOW_expr_in_binaryOps519 = new BitSet(
      new long[]{0x0071FF80000FB200L});
  public static final BitSet FOLLOW_expr_in_binaryOps523 = new BitSet(
      new long[]{0x0000000000000008L});
  public static final BitSet FOLLOW_eqop_in_binaryOps534 = new BitSet(
      new long[]{0x0000000000000004L});
  public static final BitSet FOLLOW_expr_in_binaryOps538 = new BitSet(
      new long[]{0x0071FF80000FB200L});
  public static final BitSet FOLLOW_expr_in_binaryOps542 = new BitSet(
      new long[]{0x0000000000000008L});
  public static final BitSet FOLLOW_INDEX_in_arrayRef567 = new BitSet(
      new long[]{0x0000000000000004L});
  public static final BitSet FOLLOW_ID_in_arrayRef569 = new BitSet(new long[]{0x0071FF80000FB200L});
  public static final BitSet FOLLOW_expr_in_arrayRef571 = new BitSet(
      new long[]{0x0000000000000008L});
