...
public class CymbolParser extends Parser {
  ...
  public static final String[] tokenNames = new String[]{
      "<invalid>", "<EOR>", "<DOWN>", "<UP>", "METHOD_DECL", "ARG_DECL", "BLOCK", "VAR_DECL",
      "FIELD_DECL", "CALL", "ELIST", "EXPR", "UNARY_MINUS", "UNARY_NOT", "ASSIGN", "ADDR", "DEREF",
      "ADD", "MEMBER", "ID", "INT", "FLOAT", "CHAR", "LETTER", "WS", "SL_COMMENT", "'class'", "'{'",
      "'}'", "';'", "':'", "'('", "')'", "','", "'[]'", "'*'", "'float'", "'int'", "'char'",
      "'boolean'", "'void'", "'if'", "'else'", "'return'", "'!='", "'=='", "'<'", "'>'", "'<='",
      "'>='", "'-'", "'/'", "'!'", "'&'", "'['", "']'", "'->'", "'true'", "'false'"
  };
  ...
  // delegates
  // delegators
  public static final BitSet FOLLOW_classDeclaration_in_compilationUnit188 = new BitSet(
      new long[]{0x000001F004080002L});
  public static final BitSet FOLLOW_methodDeclaration_in_compilationUnit192 = new BitSet(
      new long[]{0x000001F004080002L});
  public static final BitSet FOLLOW_varDeclaration_in_compilationUnit196 = new BitSet(
      new long[]{0x000001F004080002L});
  public static final BitSet FOLLOW_26_in_classDeclaration226 = new BitSet(
      new long[]{0x0000000000080000L});
  public static final BitSet FOLLOW_ID_in_classDeclaration228 = new BitSet(
      new long[]{0x0000000048000000L});
  public static final BitSet FOLLOW_superClass_in_classDeclaration230 = new BitSet(
      new long[]{0x0000000008000000L});
  public static final BitSet FOLLOW_27_in_classDeclaration233 = new BitSet(
      new long[]{0x000001F004080000L});
  public static final BitSet FOLLOW_classMember_in_classDeclaration235 = new BitSet(
      new long[]{0x000001F014080000L});

  ;
  public static final BitSet FOLLOW_28_in_classDeclaration238 = new BitSet(
      new long[]{0x0000000020000000L});
  // $ANTLR end "compilationUnit"
  public static final BitSet FOLLOW_29_in_classDeclaration240 = new BitSet(
      new long[]{0x0000000000000002L});

  ;
  public static final BitSet FOLLOW_30_in_superClass280 = new BitSet(
      new long[]{0x0000000000080000L});
  // $ANTLR end "classDeclaration"
  public static final BitSet FOLLOW_ID_in_superClass282 = new BitSet(
      new long[]{0x0000000000000002L});

  ;
  public static final BitSet FOLLOW_varDeclaration_in_classMember309 = new BitSet(
      new long[]{0x0000000000000002L});
  // $ANTLR end "superClass"
  public static final BitSet FOLLOW_methodDeclaration_in_classMember319 = new BitSet(
      new long[]{0x0000000000000002L});

  ;
  public static final BitSet FOLLOW_type_in_methodDeclaration342 = new BitSet(
      new long[]{0x0000000000080000L});
  // $ANTLR end "classMember"
  public static final BitSet FOLLOW_ID_in_methodDeclaration344 = new BitSet(
      new long[]{0x0000000080000000L});

  ;
  public static final BitSet FOLLOW_31_in_methodDeclaration346 = new BitSet(
      new long[]{0x000001F100080000L});
  // $ANTLR end "methodDeclaration"
  public static final BitSet FOLLOW_formalParameters_in_methodDeclaration348 = new BitSet(
      new long[]{0x0000000100000000L});

  ;
  public static final BitSet FOLLOW_32_in_methodDeclaration351 = new BitSet(
      new long[]{0x0000000008000000L});
  // $ANTLR end "formalParameters"
  public static final BitSet FOLLOW_block_in_methodDeclaration353 = new BitSet(
      new long[]{0x0000000000000002L});

  ;
  public static final BitSet FOLLOW_parameter_in_formalParameters396 = new BitSet(
      new long[]{0x0000000200000002L});
  // $ANTLR end "parameter"
  public static final BitSet FOLLOW_33_in_formalParameters399 = new BitSet(
      new long[]{0x000001F000080000L});

  ;
  public static final BitSet FOLLOW_parameter_in_formalParameters401 = new BitSet(
      new long[]{0x0000000200000002L});
  // $ANTLR end "type"
  public static final BitSet FOLLOW_type_in_parameter431 = new BitSet(
      new long[]{0x0000000000080000L});

  ;
  public static final BitSet FOLLOW_ID_in_parameter433 = new BitSet(
      new long[]{0x0000000000000002L});
  // $ANTLR end "primitiveType"
  public static final BitSet FOLLOW_type_in_parameter458 = new BitSet(
      new long[]{0x0000000000080000L});

  ;
  public static final BitSet FOLLOW_ID_in_parameter460 = new BitSet(
      new long[]{0x0000000400000000L});
  // $ANTLR end "block"
  public static final BitSet FOLLOW_34_in_parameter462 = new BitSet(
      new long[]{0x0000000000000002L});

  ;
  public static final BitSet FOLLOW_type_in_parameter486 = new BitSet(
      new long[]{0x0000000800000000L});
  // $ANTLR end "varDeclaration"
  public static final BitSet FOLLOW_35_in_parameter488 = new BitSet(
      new long[]{0x0000000000080000L});

  ;
  public static final BitSet FOLLOW_ID_in_parameter490 = new BitSet(
      new long[]{0x0000000000000002L});
  // $ANTLR end "statement"
  public static final BitSet FOLLOW_primitiveType_in_type519 = new BitSet(
      new long[]{0x0000000000000002L});
  ...
  public static final BitSet FOLLOW_statement_in_block610 = new BitSet(
      new long[]{0x06340BF89C780000L});

    public static final BitSet FOLLOW_28_in_block613 = new BitSet(new long[]{0x0000000000000002L});
  // $ANTLR end "expression"
  public static final BitSet FOLLOW_type_in_varDeclaration643 = new BitSet(
      new long[]{0x0000000000080000L});

    public static final BitSet FOLLOW_ID_in_varDeclaration645 = new BitSet(
      new long[]{0x0000000020004000L});
  // $ANTLR end "expr"
  public static final BitSet FOLLOW_ASSIGN_in_varDeclaration648 = new BitSet(
      new long[]{0x0634000880780000L});

    public static final BitSet FOLLOW_expression_in_varDeclaration650 = new BitSet(
      new long[]{0x0000000020000000L});
  // $ANTLR end "equalityExpression"
  public static final BitSet FOLLOW_29_in_varDeclaration654 = new BitSet(
      new long[]{0x0000000000000002L});

    public static final BitSet FOLLOW_type_in_varDeclaration689 = new BitSet(
      new long[]{0x0000000000080000L});
  // $ANTLR end "relationalExpression"
  public static final BitSet FOLLOW_ID_in_varDeclaration691 = new BitSet(
      new long[]{0x0000000400000000L});

    public static final BitSet FOLLOW_34_in_varDeclaration693 = new BitSet(
      new long[]{0x0000000020004000L});
  // $ANTLR end "additiveExpression"
  public static final BitSet FOLLOW_ASSIGN_in_varDeclaration696 = new BitSet(
      new long[]{0x0634000880780000L});

    public static final BitSet FOLLOW_expression_in_varDeclaration698 = new BitSet(
      new long[]{0x0000000020000000L});
  // $ANTLR end "multiplicativeExpression"
  public static final BitSet FOLLOW_29_in_varDeclaration702 = new BitSet(
      new long[]{0x0000000000000002L});

    public static final BitSet FOLLOW_type_in_varDeclaration741 = new BitSet(
      new long[]{0x0000000800000000L});
  // $ANTLR end "unaryExpression"
  public static final BitSet FOLLOW_35_in_varDeclaration743 = new BitSet(
      new long[]{0x0000000000080000L});

    public static final BitSet FOLLOW_ID_in_varDeclaration745 = new BitSet(
      new long[]{0x0000000020004000L});
  // $ANTLR end "postfixExpression"
  public static final BitSet FOLLOW_ASSIGN_in_varDeclaration748 = new BitSet(
      new long[]{0x0634000880780000L});

    public static final BitSet FOLLOW_expression_in_varDeclaration750 = new BitSet(
      new long[]{0x0000000020000000L});
  // $ANTLR end "primary"
  public static final BitSet FOLLOW_29_in_varDeclaration754 = new BitSet(
      new long[]{0x0000000000000002L});
  // $ANTLR end synpred2_Cymbol
  public static final BitSet FOLLOW_block_in_statement810 = new BitSet(
      new long[]{0x0000000000000002L});
  // $ANTLR end synpred5_Cymbol

  // Delegated rules
  public static final BitSet FOLLOW_varDeclaration_in_statement820 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_41_in_statement830 = new BitSet(
      new long[]{0x0000000080000000L});
  public static final BitSet FOLLOW_31_in_statement832 = new BitSet(
      new long[]{0x0634000880780000L});
  public static final BitSet FOLLOW_expression_in_statement834 = new BitSet(
      new long[]{0x0000000100000000L});
  public static final BitSet FOLLOW_32_in_statement836 = new BitSet(
      new long[]{0x06340BF88C780000L});
  public static final BitSet FOLLOW_statement_in_statement840 = new BitSet(
      new long[]{0x0000040000000002L});
  public static final BitSet FOLLOW_42_in_statement843 = new BitSet(
      new long[]{0x06340BF88C780000L});
  public static final BitSet FOLLOW_statement_in_statement847 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_43_in_statement882 = new BitSet(
      new long[]{0x06340008A0780000L});
  public static final BitSet FOLLOW_expression_in_statement884 = new BitSet(
      new long[]{0x0000000020000000L});
  public static final BitSet FOLLOW_29_in_statement887 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_lhs_in_statement906 = new BitSet(
      new long[]{0x0000000000004000L});
  public static final BitSet FOLLOW_ASSIGN_in_statement908 = new BitSet(
      new long[]{0x0634000880780000L});
  public static final BitSet FOLLOW_expression_in_statement910 = new BitSet(
      new long[]{0x0000000020000000L});
  public static final BitSet FOLLOW_29_in_statement912 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_postfixExpression_in_statement934 = new BitSet(
      new long[]{0x0000000020000000L});
  public static final BitSet FOLLOW_29_in_statement936 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_unaryExpression_in_lhs972 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_expr_in_expressionList999 = new BitSet(
      new long[]{0x0000000200000002L});
  public static final BitSet FOLLOW_33_in_expressionList1002 = new BitSet(
      new long[]{0x0634000880780000L});
  public static final BitSet FOLLOW_expr_in_expressionList1004 = new BitSet(
      new long[]{0x0000000200000002L});
  public static final BitSet FOLLOW_expr_in_expression1046 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_equalityExpression_in_expr1068 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_relationalExpression_in_equalityExpression1091 = new BitSet(
      new long[]{0x0000300000000002L});
  public static final BitSet FOLLOW_44_in_equalityExpression1095 = new BitSet(
      new long[]{0x0634000880780000L});
  public static final BitSet FOLLOW_45_in_equalityExpression1100 = new BitSet(
      new long[]{0x0634000880780000L});
  public static final BitSet FOLLOW_relationalExpression_in_equalityExpression1104 = new BitSet(
      new long[]{0x0000300000000002L});
  public static final BitSet FOLLOW_additiveExpression_in_relationalExpression1125 = new BitSet(
      new long[]{0x0003C00000000002L});
  public static final BitSet FOLLOW_46_in_relationalExpression1147 = new BitSet(
      new long[]{0x0634000880780000L});
  public static final BitSet FOLLOW_47_in_relationalExpression1170 = new BitSet(
      new long[]{0x0634000880780000L});
  public static final BitSet FOLLOW_48_in_relationalExpression1193 = new BitSet(
      new long[]{0x0634000880780000L});
  public static final BitSet FOLLOW_49_in_relationalExpression1216 = new BitSet(
      new long[]{0x0634000880780000L});
  public static final BitSet FOLLOW_additiveExpression_in_relationalExpression1253 = new BitSet(
      new long[]{0x0003C00000000002L});
  public static final BitSet FOLLOW_multiplicativeExpression_in_additiveExpression1297 = new BitSet(
      new long[]{0x0004000000020002L});
  public static final BitSet FOLLOW_ADD_in_additiveExpression1301 = new BitSet(
      new long[]{0x0634000880780000L});
  public static final BitSet FOLLOW_50_in_additiveExpression1306 = new BitSet(
      new long[]{0x0634000880780000L});
  public static final BitSet FOLLOW_multiplicativeExpression_in_additiveExpression1310 = new BitSet(
      new long[]{0x0004000000020002L});
  public static final BitSet FOLLOW_unaryExpression_in_multiplicativeExpression1331 = new BitSet(
      new long[]{0x0008000800000002L});
  public static final BitSet FOLLOW_35_in_multiplicativeExpression1335 = new BitSet(
      new long[]{0x0634000880780000L});
  public static final BitSet FOLLOW_51_in_multiplicativeExpression1340 = new BitSet(
      new long[]{0x0634000880780000L});
  public static final BitSet FOLLOW_unaryExpression_in_multiplicativeExpression1344 = new BitSet(
      new long[]{0x0008000800000002L});
  public static final BitSet FOLLOW_50_in_unaryExpression1367 = new BitSet(
      new long[]{0x0634000880780000L});
  public static final BitSet FOLLOW_unaryExpression_in_unaryExpression1369 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_52_in_unaryExpression1390 = new BitSet(
      new long[]{0x0634000880780000L});
  public static final BitSet FOLLOW_unaryExpression_in_unaryExpression1392 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_53_in_unaryExpression1413 = new BitSet(
      new long[]{0x0634000880780000L});
  public static final BitSet FOLLOW_unaryExpression_in_unaryExpression1415 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_35_in_unaryExpression1436 = new BitSet(
      new long[]{0x0634000880780000L});
  public static final BitSet FOLLOW_unaryExpression_in_unaryExpression1438 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_postfixExpression_in_unaryExpression1457 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_primary_in_postfixExpression1478 = new BitSet(
      new long[]{0x0140000080040002L});
  public static final BitSet FOLLOW_31_in_postfixExpression1509 = new BitSet(
      new long[]{0x0634000980780000L});
  public static final BitSet FOLLOW_expressionList_in_postfixExpression1511 = new BitSet(
      new long[]{0x0000000100000000L});
  public static final BitSet FOLLOW_32_in_postfixExpression1513 = new BitSet(
      new long[]{0x0140000080040002L});
  public static final BitSet FOLLOW_54_in_postfixExpression1561 = new BitSet(
      new long[]{0x0634000880780000L});
  public static final BitSet FOLLOW_expr_in_postfixExpression1563 = new BitSet(
      new long[]{0x0080000000000000L});
  public static final BitSet FOLLOW_55_in_postfixExpression1565 = new BitSet(
      new long[]{0x0140000080040002L});
  public static final BitSet FOLLOW_MEMBER_in_postfixExpression1617 = new BitSet(
      new long[]{0x0000000000080000L});
  public static final BitSet FOLLOW_ID_in_postfixExpression1619 = new BitSet(
      new long[]{0x0140000080040002L});
  public static final BitSet FOLLOW_56_in_postfixExpression1666 = new BitSet(
      new long[]{0x0000000000080000L});
  public static final BitSet FOLLOW_ID_in_postfixExpression1668 = new BitSet(
      new long[]{0x0140000080040002L});
  public static final BitSet FOLLOW_ID_in_primary1774 = new BitSet(new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_INT_in_primary1784 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_FLOAT_in_primary1794 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_CHAR_in_primary1804 = new BitSet(
      new long[]{0x0000000000000002L});
  ...
  public static final BitSet FOLLOW_expr_in_primary1836 = new BitSet(
      new long[]{0x0000000100000000L});
  public static final BitSet FOLLOW_32_in_primary1838 = new BitSet(new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_varDeclaration_in_synpred2_Cymbol820 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_lhs_in_synpred5_Cymbol906 = new BitSet(
      new long[]{0x0000000000004000L});
  public static final BitSet FOLLOW_ASSIGN_in_synpred5_Cymbol908 = new BitSet(
      new long[]{0x0634000880780000L});
  public static final BitSet FOLLOW_expression_in_synpred5_Cymbol910 = new BitSet(
      new long[]{0x0000000020000000L});
  public static final BitSet FOLLOW_29_in_synpred5_Cymbol912 = new BitSet(
      new long[]{0x0000000000000002L});
  ...
  public String getGrammarFileName() {
    return "/Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g";
  }
  ...
  public final CymbolParser.compilationUnit_return compilationUnit() throws RecognitionException {
    ...
    try {
          ...
          switch (alt1) {
              ...
              // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:27:13: classDeclaration
            {
              ...
              state._fsp--;
                ...
                if (state.backtracking == 0) {
                    adaptor.addChild(root_0, classDeclaration1.getTree());
                }
              ...
              // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:27:52: varDeclaration
            {
              ...
              state._fsp--;
                ...
                if (state.backtracking == 0) {
                    adaptor.addChild(root_0, varDeclaration3.getTree());
                }
      ...
      if (state.backtracking == 0) {
        retval.tree.setUnknownTokenBoundaries();
      }
  ...
  public final CymbolParser.classDeclaration_return classDeclaration() throws RecognitionException {
    ...
    RewriteRuleSubtreeStream stream_classMember = new RewriteRuleSubtreeStream(adaptor,
        "rule classMember");
    RewriteRuleSubtreeStream stream_superClass = new RewriteRuleSubtreeStream(adaptor,
        "rule superClass");
    try {
      ...
      {
        string_literal4 = (Token) match(input, 26, FOLLOW_26_in_classDeclaration226);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
        ...
        ID5 = (Token) match(input, ID, FOLLOW_ID_in_classDeclaration228);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
        ...
        switch (alt2) {
            ...
            // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:32:20: superClass
          {
            ...
            state._fsp--;
              ...
              if (state.backtracking == 0) {
                  stream_superClass.add(superClass6.getTree());
              }
        ...
        char_literal7 = (Token) match(input, 27, FOLLOW_27_in_classDeclaration233);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
          ...
          switch (alt3) {
              ...
              // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:32:36: classMember
            {
              ...
              state._fsp--;
                ...
                if (state.backtracking == 0) {
                    stream_classMember.add(classMember8.getTree());
                }
        ...
        char_literal9 = (Token) match(input, 28, FOLLOW_28_in_classDeclaration238);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
        ...
        char_literal10 = (Token) match(input, 29, FOLLOW_29_in_classDeclaration240);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
  ...
  public final CymbolParser.superClass_return superClass() throws RecognitionException {
    ...
    try {
      ...
      {
        char_literal11 = (Token) match(input, 30, FOLLOW_30_in_superClass280);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
        ...
        ID12 = (Token) match(input, ID, FOLLOW_ID_in_superClass282);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
      ...
      switch (alt4) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:40:9: varDeclaration
        {
          ...
          state._fsp--;
            ...
            if (state.backtracking == 0) {
                adaptor.addChild(root_0, varDeclaration13.getTree());
            }
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:41:9: methodDeclaration
        {
          ...
          state._fsp--;
            ...
            if (state.backtracking == 0) {
                adaptor.addChild(root_0, methodDeclaration14.getTree());
            }
  ...
  public final CymbolParser.methodDeclaration_return methodDeclaration()
    ...
    RewriteRuleTokenStream stream_ID = new RewriteRuleTokenStream(adaptor, "token ID");
    RewriteRuleSubtreeStream stream_formalParameters = new RewriteRuleSubtreeStream(adaptor,
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:46:9: type ID '(' ( formalParameters )? ')' block
      {
        ...
        ID16 = (Token) match(input, ID, FOLLOW_ID_in_methodDeclaration344);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
        ...
        char_literal17 = (Token) match(input, 31, FOLLOW_31_in_methodDeclaration346);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
        ...
        switch (alt5) {
            ...
            // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:46:21: formalParameters
          {
            ...
            state._fsp--;
              ...
              if (state.backtracking == 0) {
                  stream_formalParameters.add(formalParameters18.getTree());
              }
        ...
        char_literal19 = (Token) match(input, 32, FOLLOW_32_in_methodDeclaration351);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
        ...
        state._fsp--;
          ...
          if (state.backtracking == 0) {
              stream_block.add(block20.getTree());
          }
          ...
          // 47:9: -> ^( METHOD_DECL type ID ( formalParameters )? block )
          {
            // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:47:12: ^( METHOD_DECL type ID ( formalParameters )? block )
            {
              ...
              root_1 = (CymbolAST) adaptor
                  .becomeRoot(adaptor.create(METHOD_DECL, "METHOD_DECL"), root_1);
  ...
  public final CymbolParser.formalParameters_return formalParameters() throws RecognitionException {
    ...
    RewriteRuleSubtreeStream stream_parameter = new RewriteRuleSubtreeStream(adaptor,
        "rule parameter");
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:52:9: parameter ( ',' parameter )*
      {
        ...
        do {
          ...
          switch (alt6) {
            ...
            {
              char_literal22 = (Token) match(input, 33, FOLLOW_33_in_formalParameters399);
                if (state.failed) {
                    return retval;
                }
                if (state.backtracking == 0) {
    ...
    try {
      ...
      switch (alt7) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:56:9: type ID
        {
          ...
          ID25 = (Token) match(input, ID, FOLLOW_ID_in_parameter433);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          if (state.backtracking == 0) {
            ...
            // 56:22: -> ^( ARG_DECL type ID )
            {
              // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:56:25: ^( ARG_DECL type ID )
              {
                CymbolAST root_1 = (CymbolAST) adaptor.nil();
                root_1 = (CymbolAST) adaptor
                    .becomeRoot(adaptor.create(ARG_DECL, "ARG_DECL"), root_1);
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:57:9: type ID '[]'
        {
          ...
          ID27 = (Token) match(input, ID, FOLLOW_ID_in_parameter460);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          string_literal28 = (Token) match(input, 34, FOLLOW_34_in_parameter462);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
            ...
            // 57:22: -> ^( ARG_DECL ^( '*' type ) ID )
            {
              // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:57:25: ^( ARG_DECL ^( '*' type ) ID )
              {
                ...
                // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:57:36: ^( '*' type )
                {
                  ...
                  root_2 = (CymbolAST) adaptor
                      .becomeRoot(adaptor.create(35, "35"), root_2);
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:58:9: type '*' ID
        {
          ...
          char_literal30 = (Token) match(input, 35, FOLLOW_35_in_parameter488);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          ID31 = (Token) match(input, ID, FOLLOW_ID_in_parameter490);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
      ...
      switch (alt8) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:61:9: primitiveType
        {
          ...
          state._fsp--;
            ...
            if (state.backtracking == 0) {
                adaptor.addChild(root_0, primitiveType32.getTree());
            }
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:62:9: ID
        {
          ...
          ID33 = (Token) match(input, ID, FOLLOW_ID_in_type529);
            if (state.failed) {
                return retval;
            }
          if (state.backtracking == 0) {
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:
      {
        ...
        if ((input.LA(1) >= 36 && input.LA(1) <= 40)) {
          input.consume();
            if (state.backtracking == 0) {
                adaptor.addChild(root_0, adaptor.create(set34));
            }
  ...
  public final CymbolParser.block_return block() throws RecognitionException {
    ...
    try {
      ...
      {
        char_literal35 = (Token) match(input, 27, FOLLOW_27_in_block608);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
        ...
        do {
          ...
          if (((LA9_0 >= ID && LA9_0 <= CHAR) || LA9_0 == 27 || LA9_0 == 31 || (LA9_0 >= 35
              && LA9_0 <= 41) || LA9_0 == 43 || LA9_0 == 50 || (LA9_0 >= 52 && LA9_0 <= 53) || (
              LA9_0 >= 57 && LA9_0 <= 58))) {
            alt9 = 1;
          }
          ...
          switch (alt9) {
              ...
              // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:75:13: statement
            {
              ...
              state._fsp--;
                ...
                if (state.backtracking == 0) {
                    stream_statement.add(statement36.getTree());
                }
        ...
        char_literal37 = (Token) match(input, 28, FOLLOW_28_in_block613);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
        ...
        if (state.backtracking == 0) {
          ...
          // 75:28: -> ^( BLOCK ( statement )* )
          {
            // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:75:31: ^( BLOCK ( statement )* )
            {
              CymbolAST root_1 = (CymbolAST) adaptor.nil();
              root_1 = (CymbolAST) adaptor
                  .becomeRoot(adaptor.create(BLOCK, "BLOCK"), root_1);
  ...
  public final CymbolParser.varDeclaration_return varDeclaration() throws RecognitionException {
    ...
    RewriteRuleTokenStream stream_ID = new RewriteRuleTokenStream(adaptor, "token ID");
    RewriteRuleSubtreeStream stream_type = new RewriteRuleSubtreeStream(adaptor, "rule type");
    RewriteRuleSubtreeStream stream_expression = new RewriteRuleSubtreeStream(adaptor,
        "rule expression");
    try {
      ...
      switch (alt13) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:81:9: type ID ( '=' expression )? ';'
        {
          ...
          ID39 = (Token) match(input, ID, FOLLOW_ID_in_varDeclaration645);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          switch (alt10) {
            ...
            {
              char_literal40 = (Token) match(input, ASSIGN, FOLLOW_ASSIGN_in_varDeclaration648);
                if (state.failed) {
                    return retval;
                }
                if (state.backtracking == 0) {
          ...
          char_literal42 = (Token) match(input, 29, FOLLOW_29_in_varDeclaration654);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          if (state.backtracking == 0) {
            ...
            // 82:13: -> ^( VAR_DECL type ID ( expression )? )
            {
              // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:82:16: ^( VAR_DECL type ID ( expression )? )
              {
                CymbolAST root_1 = (CymbolAST) adaptor.nil();
                root_1 = (CymbolAST) adaptor
                    .becomeRoot(adaptor.create(VAR_DECL, "VAR_DECL"), root_1);
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:83:9: type ID '[]' ( '=' expression )? ';'
        {
          ...
          ID44 = (Token) match(input, ID, FOLLOW_ID_in_varDeclaration691);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          string_literal45 = (Token) match(input, 34, FOLLOW_34_in_varDeclaration693);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          switch (alt11) {
            ...
            {
              char_literal46 = (Token) match(input, ASSIGN, FOLLOW_ASSIGN_in_varDeclaration696);
                if (state.failed) {
                    return retval;
                }
                if (state.backtracking == 0) {
          ...
          char_literal48 = (Token) match(input, 29, FOLLOW_29_in_varDeclaration702);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:85:9: type '*' ID ( '=' expression )? ';'
        {
          ...
          char_literal50 = (Token) match(input, 35, FOLLOW_35_in_varDeclaration743);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          ID51 = (Token) match(input, ID, FOLLOW_ID_in_varDeclaration745);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          switch (alt12) {
            ...
            {
              char_literal52 = (Token) match(input, ASSIGN, FOLLOW_ASSIGN_in_varDeclaration748);
                if (state.failed) {
                    return retval;
                }
                if (state.backtracking == 0) {
                    stream_ASSIGN.add(char_literal52);
                }
          ...
          char_literal54 = (Token) match(input, 29, FOLLOW_29_in_varDeclaration754);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
                stream_29.add(char_literal54);
            }
  ...
  public final CymbolParser.statement_return statement() throws RecognitionException {
    ...
    RewriteRuleSubtreeStream stream_expression = new RewriteRuleSubtreeStream(adaptor,
        "rule expression");
    RewriteRuleSubtreeStream stream_postfixExpression = new RewriteRuleSubtreeStream(adaptor,
      ...
      switch (alt16) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:93:9: varDeclaration
        {
          ...
          state._fsp--;
            ...
            if (state.backtracking == 0) {
                adaptor.addChild(root_0, varDeclaration56.getTree());
            }
        ...
        {
          string_literal57 = (Token) match(input, 41, FOLLOW_41_in_statement830);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          char_literal58 = (Token) match(input, 31, FOLLOW_31_in_statement832);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          char_literal60 = (Token) match(input, 32, FOLLOW_32_in_statement836);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          switch (alt14) {
            ...
            {
              string_literal61 = (Token) match(input, 42, FOLLOW_42_in_statement843);
                if (state.failed) {
                    return retval;
                }
                if (state.backtracking == 0) {
        ...
        {
          string_literal62 = (Token) match(input, 43, FOLLOW_43_in_statement882);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
                stream_43.add(string_literal62);
            }
          ...
          if (((LA15_0 >= ID && LA15_0 <= CHAR) || LA15_0 == 31 || LA15_0 == 35 || LA15_0 == 50 || (
              LA15_0 >= 52 && LA15_0 <= 53) || (LA15_0 >= 57 && LA15_0 <= 58))) {
            alt15 = 1;
          }
          switch (alt15) {
            case 1:
          ...
          char_literal64 = (Token) match(input, 29, FOLLOW_29_in_statement887);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:97:9: lhs '=' expression ';'
        {
          ...
          state._fsp--;
            ...
            if (state.backtracking == 0) {
                stream_lhs.add(lhs65.getTree());
            }
          char_literal66 = (Token) match(input, ASSIGN, FOLLOW_ASSIGN_in_statement908);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          char_literal68 = (Token) match(input, 29, FOLLOW_29_in_statement912);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:98:9: a= postfixExpression ';'
        {
          ...
          state._fsp--;
            ...
            if (state.backtracking == 0) {
                stream_postfixExpression.add(a.getTree());
            }
          char_literal69 = (Token) match(input, 29, FOLLOW_29_in_statement936);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:102:9: unaryExpression
      {
        ...
        state._fsp--;
          ...
          if (state.backtracking == 0) {
              stream_unaryExpression.add(unaryExpression70.getTree());
          }
  ...
  public final CymbolParser.expressionList_return expressionList() throws RecognitionException {
    ...
    try {
      ...
      if (((LA18_0 >= ID && LA18_0 <= CHAR) || LA18_0 == 31 || LA18_0 == 35 || LA18_0 == 50 || (
          LA18_0 >= 52 && LA18_0 <= 53) || (LA18_0 >= 57 && LA18_0 <= 58))) {
        alt18 = 1;
      } else if ((LA18_0 == 32)) {
        alt18 = 2;
      } else {
      ...
      switch (alt18) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:105:9: expr ( ',' expr )*
        {
          ...
          do {
            ...
            switch (alt17) {
              ...
              {
                char_literal72 = (Token) match(input, 33, FOLLOW_33_in_expressionList1002);
                  if (state.failed) {
                      return retval;
                  }
                  if (state.backtracking == 0) {
          ...
          if (state.backtracking == 0) {
            ...
            // 105:26: -> ^( ELIST ( expr )+ )
            {
              // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:105:29: ^( ELIST ( expr )+ )
              {
                CymbolAST root_1 = (CymbolAST) adaptor.nil();
                root_1 = (CymbolAST) adaptor
                    .becomeRoot(adaptor.create(ELIST, "ELIST"), root_1);
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:106:9:
        {
          ...
          if (state.backtracking == 0) {
            ...
            // 106:9: -> ELIST
            {
              adaptor.addChild(root_0, adaptor.create(ELIST, "ELIST"));
  ...
  public final CymbolParser.equalityExpression_return equalityExpression()
      throws RecognitionException {
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:117:9: relationalExpression ( ( '!=' | '==' ) relationalExpression )*
      {
        ...
        state._fsp--;
          ...
          if (state.backtracking == 0) {
              adaptor.addChild(root_0, relationalExpression76.getTree());
          }
          ...
          switch (alt20) {
              ...
              // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:117:31: ( '!=' | '==' ) relationalExpression
            {
              ...
              switch (alt19) {
                ...
                {
                  string_literal77 = (Token) match(input, 44, FOLLOW_44_in_equalityExpression1095);
                    if (state.failed) {
                        return retval;
                    }
                  if (state.backtracking == 0) {
                ...
                {
                  string_literal78 = (Token) match(input, 45, FOLLOW_45_in_equalityExpression1100);
                    if (state.failed) {
                        return retval;
                    }
                  if (state.backtracking == 0) {
              ...
              state._fsp--;
                ...
                if (state.backtracking == 0) {
                    adaptor.addChild(root_0, relationalExpression79.getTree());
                }
  ...
  public final CymbolParser.relationalExpression_return relationalExpression()
      throws RecognitionException {
            ...
            switch (alt22) {
                ...
                // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:122:17: ( '<' | '>' | '<=' | '>=' ) additiveExpression
              {
                ...
                switch (alt21) {
                  ...
                  {
                    char_literal81 = (Token) match(input, 46,
                        FOLLOW_46_in_relationalExpression1147);
                      if (state.failed) {
                          return retval;
                      }
                    if (state.backtracking == 0) {
                  ...
                  {
                    char_literal82 = (Token) match(input, 47,
                        FOLLOW_47_in_relationalExpression1170);
                      if (state.failed) {
                          return retval;
                      }
                    if (state.backtracking == 0) {
                  ...
                  {
                    string_literal83 = (Token) match(input, 48,
                        FOLLOW_48_in_relationalExpression1193);
                      if (state.failed) {
                          return retval;
                      }
                    if (state.backtracking == 0) {
                  ...
                  {
                    string_literal84 = (Token) match(input, 49,
                        FOLLOW_49_in_relationalExpression1216);
                      if (state.failed) {
                          return retval;
                      }
                    if (state.backtracking == 0) {
  ...
  public final CymbolParser.additiveExpression_return additiveExpression()
      throws RecognitionException {
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:133:9: multiplicativeExpression ( ( '+' | '-' ) multiplicativeExpression )*
      {
        ...
        state._fsp--;
          ...
          if (state.backtracking == 0) {
              adaptor.addChild(root_0, multiplicativeExpression86.getTree());
          }
          ...
          switch (alt24) {
              ...
              // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:133:35: ( '+' | '-' ) multiplicativeExpression
            {
              ...
              switch (alt23) {
                ...
                {
                  char_literal87 = (Token) match(input, ADD, FOLLOW_ADD_in_additiveExpression1301);
                    if (state.failed) {
                        return retval;
                    }
                  if (state.backtracking == 0) {
                ...
                {
                  char_literal88 = (Token) match(input, 50, FOLLOW_50_in_additiveExpression1306);
                    if (state.failed) {
                        return retval;
                    }
                  if (state.backtracking == 0) {
  ...
  public final CymbolParser.multiplicativeExpression_return multiplicativeExpression()
      throws RecognitionException {
          ...
          switch (alt26) {
              ...
              // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:137:26: ( '*' | '/' ) unaryExpression
            {
              ...
              switch (alt25) {
                ...
                {
                  char_literal91 = (Token) match(input, 35,
                      FOLLOW_35_in_multiplicativeExpression1335);
                    if (state.failed) {
                        return retval;
                    }
                  if (state.backtracking == 0) {
                ...
                {
                  char_literal92 = (Token) match(input, 51,
                      FOLLOW_51_in_multiplicativeExpression1340);
                    if (state.failed) {
                        return retval;
                    }
                  if (state.backtracking == 0) {
  ...
  public final CymbolParser.postfixExpression_return postfixExpression()
      throws RecognitionException {
    ...
    RewriteRuleSubtreeStream stream_expr = new RewriteRuleSubtreeStream(adaptor, "rule expr");
    RewriteRuleSubtreeStream stream_expressionList = new RewriteRuleSubtreeStream(adaptor,
        "rule expressionList");
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:150:9: ( primary -> primary ) ( ( '(' expressionList ')' -> ^( CALL[\"CALL\"] $postfixExpression expressionList ) | r= '[' expr ']' -> ^( DEREF[$r,\"*\"] ^( ADD[\"+\"] $postfixExpression expr ) ) | '.' ID -> ^( '.' $postfixExpression ID ) | r= '->' ID -> ^( MEMBER[$r] ^( DEREF $postfixExpression) ID ) ) )*
      {
        ...
        // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:150:10: primary
        {
          ...
          state._fsp--;
            ...
            if (state.backtracking == 0) {
                stream_primary.add(primary99.getTree());
            }
          ...
          switch (alt29) {
              ...
              // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:152:13: ( '(' expressionList ')' -> ^( CALL[\"CALL\"] $postfixExpression expressionList ) | r= '[' expr ']' -> ^( DEREF[$r,\"*\"] ^( ADD[\"+\"] $postfixExpression expr ) ) | '.' ID -> ^( '.' $postfixExpression ID ) | r= '->' ID -> ^( MEMBER[$r] ^( DEREF $postfixExpression) ID ) )
            {
              ...
              switch (alt28) {
                ...
                {
                  char_literal100 = (Token) match(input, 31, FOLLOW_31_in_postfixExpression1509);
                    if (state.failed) {
                        return retval;
                    }
                    if (state.backtracking == 0) {
                  ...
                  state._fsp--;
                    ...
                    if (state.backtracking == 0) {
                        stream_expressionList.add(expressionList101.getTree());
                    }
                  char_literal102 = (Token) match(input, 32, FOLLOW_32_in_postfixExpression1513);
                    if (state.failed) {
                        return retval;
                    }
                    if (state.backtracking == 0) {
                  ...
                  if (state.backtracking == 0) {
                    ...
                    // 153:17: -> ^( CALL[\"CALL\"] $postfixExpression expressionList )
                    {
                      // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:153:20: ^( CALL[\"CALL\"] $postfixExpression expressionList )
                      {
                        CymbolAST root_1 = (CymbolAST) adaptor.nil();
                        root_1 = (CymbolAST) adaptor
                            .becomeRoot(adaptor.create(CALL, "CALL"), root_1);
                ...
                {
                  r = (Token) match(input, 54, FOLLOW_54_in_postfixExpression1561);
                    if (state.failed) {
                        return retval;
                    }
                    if (state.backtracking == 0) {
                  ...
                  char_literal104 = (Token) match(input, 55, FOLLOW_55_in_postfixExpression1565);
                    if (state.failed) {
                        return retval;
                    }
                    if (state.backtracking == 0) {
                        stream_55.add(char_literal104);
                    }
                ...
                {
                  char_literal105 = (Token) match(input, MEMBER,
                      FOLLOW_MEMBER_in_postfixExpression1617);
                    if (state.failed) {
                        return retval;
                    }
                    if (state.backtracking == 0) {
                        stream_MEMBER.add(char_literal105);
                    }

                  ID106 = (Token) match(input, ID, FOLLOW_ID_in_postfixExpression1619);
                    if (state.failed) {
                        return retval;
                    }
                    if (state.backtracking == 0) {
                ...
                {
                  r = (Token) match(input, 56, FOLLOW_56_in_postfixExpression1666);
                    if (state.failed) {
                        return retval;
                    }
                    if (state.backtracking == 0) {
                  ...
                  ID107 = (Token) match(input, ID, FOLLOW_ID_in_postfixExpression1668);
                    if (state.failed) {
                        return retval;
                    }
                    if (state.backtracking == 0) {
    ...
    try {
      ...
      switch (alt30) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:166:9: ID
        {
          ...
          ID108 = (Token) match(input, ID, FOLLOW_ID_in_primary1774);
            if (state.failed) {
                return retval;
            }
          if (state.backtracking == 0) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:167:9: INT
        {
          ...
          INT109 = (Token) match(input, INT, FOLLOW_INT_in_primary1784);
            if (state.failed) {
                return retval;
            }
          if (state.backtracking == 0) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:168:9: FLOAT
        {
          ...
          FLOAT110 = (Token) match(input, FLOAT, FOLLOW_FLOAT_in_primary1794);
            if (state.failed) {
                return retval;
            }
          if (state.backtracking == 0) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:169:9: CHAR
        {
          ...
          CHAR111 = (Token) match(input, CHAR, FOLLOW_CHAR_in_primary1804);
            if (state.failed) {
                return retval;
            }
          if (state.backtracking == 0) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:170:9: 'true'
        {
          ...
          string_literal112 = (Token) match(input, 57, FOLLOW_57_in_primary1814);
            if (state.failed) {
                return retval;
            }
          if (state.backtracking == 0) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:171:9: 'false'
        {
          ...
          string_literal113 = (Token) match(input, 58, FOLLOW_58_in_primary1824);
            if (state.failed) {
                return retval;
            }
          if (state.backtracking == 0) {
        ...
        {
          char_literal114 = (Token) match(input, 31, FOLLOW_31_in_primary1834);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
                stream_31.add(char_literal114);
            }
          ...
          char_literal116 = (Token) match(input, 32, FOLLOW_32_in_primary1838);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
  ...
  public final void synpred5_Cymbol_fragment() throws RecognitionException {
    ...
    // /Users/parrt/research/book/TPDSL/Book/code/semantics/oo/Cymbol.g:97:9: lhs '=' expression ';'
    {
      ...
      match(input, ASSIGN, FOLLOW_ASSIGN_in_synpred5_Cymbol908);
        if (state.failed) {
            return;
        }
      ...
      match(input, 29, FOLLOW_29_in_synpred5_Cymbol912);
        if (state.failed) {
            return;
        }
