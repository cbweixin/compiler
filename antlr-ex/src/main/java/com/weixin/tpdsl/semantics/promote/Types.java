...
public class Types extends TreeFilter {
  ...
  public static final BitSet FOLLOW_decl_in_bottomup67 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_ret_in_bottomup77 = new BitSet(new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_assignment_in_bottomup87 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_VAR_DECL_in_decl103 = new BitSet(
  ...
  // $ANTLR end "bottomup"
  public static final BitSet FOLLOW_ASSIGN_in_assignment168 = new BitSet(
      new long[]{0x0000000000000004L});
  // $ANTLR end "decl"
  public static final BitSet FOLLOW_EXPR_in_exprRoot201 = new BitSet(
      new long[]{0x0000000000000004L});

    public static final BitSet FOLLOW_expr_in_exprRoot203 = new BitSet(
  ...
  // $ANTLR end "binaryOps"
  public static final BitSet FOLLOW_UNARY_MINUS_in_expr338 = new BitSet(
      new long[]{0x0000000000000004L});

    public static final BitSet FOLLOW_expr_in_expr342 = new BitSet(new long[]{0x0000000000000008L});
  // $ANTLR end "arrayRef"
  public static final BitSet FOLLOW_UNARY_NOT_in_expr358 = new BitSet(
      new long[]{0x0000000000000004L});
  ...
  public static final BitSet FOLLOW_member_in_expr379 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_arrayRef_in_expr396 = new BitSet(
      new long[]{0x0000000000000002L});
  // $ANTLR end "member"
  public static final BitSet FOLLOW_call_in_expr411 = new BitSet(new long[]{0x0000000000000002L});
  // $ANTLR end "bop"
  public static final BitSet FOLLOW_binaryOps_in_expr430 = new BitSet(
      new long[]{0x0000000000000002L});
  // $ANTLR end "relop"
  public static final BitSet FOLLOW_bop_in_binaryOps467 = new BitSet(
      new long[]{0x0000000000000004L});
  // $ANTLR end "eqop"

  // Delegated rules
  public static final BitSet FOLLOW_expr_in_binaryOps471 = new BitSet(
      new long[]{0x0071FF80000FB200L});
  public static final BitSet FOLLOW_expr_in_binaryOps475 = new BitSet(
      new long[]{0x0000000000000008L});
  public static final BitSet FOLLOW_relop_in_binaryOps495 = new BitSet(
      new long[]{0x0000000000000004L});
  public static final BitSet FOLLOW_expr_in_binaryOps499 = new BitSet(
      new long[]{0x0071FF80000FB200L});
  public static final BitSet FOLLOW_expr_in_binaryOps503 = new BitSet(
      new long[]{0x0000000000000008L});
  public static final BitSet FOLLOW_eqop_in_binaryOps521 = new BitSet(
      new long[]{0x0000000000000004L});
  public static final BitSet FOLLOW_expr_in_binaryOps525 = new BitSet(
      new long[]{0x0071FF80000FB200L});
  public static final BitSet FOLLOW_expr_in_binaryOps529 = new BitSet(
      new long[]{0x0000000000000008L});
  ...
  public String getGrammarFileName() {
    return "/Users/parrt/research/book/TPDSL/Book/code/semantics/promote/Types.g";
  }
  ...
  public final void decl() throws RecognitionException {
    ...
    try {
      ...
      {
        match(input, VAR_DECL, FOLLOW_VAR_DECL_in_decl103);
          if (state.failed) {
              return;
          }
        ...
        ID1 = (CymbolAST) match(input, ID, FOLLOW_ID_in_decl107);
          if (state.failed) {
              return;
          }
  ...
  public final Types.ret_return ret() throws RecognitionException {
    ...
    try {
      ...
      {
        match(input, 38, FOLLOW_38_in_ret145);
          if (state.failed) {
              return retval;
          }
  ...
  public final void assignment() throws RecognitionException {
    ...
    try {
      ...
      {
        match(input, ASSIGN, FOLLOW_ASSIGN_in_assignment168);
          if (state.failed) {
              return;
          }
  ...
  public final void exprRoot() throws RecognitionException {
    ...
    try {
      ...
      {
        EXPR2 = (CymbolAST) match(input, EXPR, FOLLOW_EXPR_in_exprRoot201);
          if (state.failed) {
              return;
          }
  ...
  public final Types.expr_return expr() throws RecognitionException {
    ...
    try {
      ...
      switch (alt3) {
        ...
        {
          match(input, 53, FOLLOW_53_in_expr235);
            if (state.failed) {
                return retval;
            }
          if (state.backtracking == 1) {
        ...
        {
          match(input, 54, FOLLOW_54_in_expr252);
            if (state.failed) {
                return retval;
            }
          if (state.backtracking == 1) {
        ...
        {
          match(input, CHAR, FOLLOW_CHAR_in_expr268);
            if (state.failed) {
                return retval;
            }
          if (state.backtracking == 1) {
        ...
        {
          match(input, INT, FOLLOW_INT_in_expr287);
            if (state.failed) {
                return retval;
            }
          if (state.backtracking == 1) {
        ...
        {
          match(input, FLOAT, FOLLOW_FLOAT_in_expr307);
            if (state.failed) {
                return retval;
            }
          if (state.backtracking == 1) {
        ...
        {
          ID4 = (CymbolAST) match(input, ID, FOLLOW_ID_in_expr325);
            if (state.failed) {
                return retval;
            }
          if (state.backtracking == 1) {
        ...
        {
          match(input, UNARY_MINUS, FOLLOW_UNARY_MINUS_in_expr338);
            if (state.failed) {
                return retval;
            }
        ...
        {
          match(input, UNARY_NOT, FOLLOW_UNARY_NOT_in_expr358);
            if (state.failed) {
                return retval;
            }
  ...
  public final Types.call_return call() throws RecognitionException {
    ...
    try {
      ...
      {
        match(input, CALL, FOLLOW_CALL_in_call611);
          if (state.failed) {
              return retval;
          }
        ...
        ID12 = (CymbolAST) match(input, ID, FOLLOW_ID_in_call613);
          if (state.failed) {
              return retval;
          }
        match(input, ELIST, FOLLOW_ELIST_in_call616);
          if (state.failed) {
              return retval;
          }
        ...
        if (input.LA(1) == Token.DOWN) {
          ...
          do {
            ...
            if ((LA5_0 == CALL || (LA5_0 >= UNARY_MINUS && LA5_0 <= UNARY_NOT) || (LA5_0 >= INDEX
                && LA5_0 <= CHAR) || (LA5_0 >= 39 && LA5_0 <= 48) || (LA5_0 >= 52
                && LA5_0 <= 54))) {
              alt5 = 1;
            }
  ...
  public final Types.member_return member() throws RecognitionException {
    ...
    try {
      ...
      {
        match(input, 52, FOLLOW_52_in_member659);
          if (state.failed) {
              return retval;
          }
        ...
        ID14 = (CymbolAST) match(input, ID, FOLLOW_ID_in_member663);
          if (state.failed) {
              return retval;
          }
