...
import com.weixin.tpdsl.enhancedparsing.backtrack.NoViableAltException;
...
public class BacktrackParser extends Parser {
  ...
  /**
   * Map input position to FAILED or previous stop token index. null implies we've not parsed this
   * rule at that index.
   */
