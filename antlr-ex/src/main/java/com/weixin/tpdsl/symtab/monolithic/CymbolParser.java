...
public class CymbolParser extends Parser {
  ...
  public static final String[] tokenNames = new String[]{
      "<invalid>", "<EOR>", "<DOWN>", "<UP>", "ID", "INT", "LETTER", "WS", "SL_COMMENT", "'float'",
      "'int'", "'='", "';'", "'+'", "'('", "')'"
  };
  ...
  public String getGrammarFileName() {
    return "/Users/parrt/research/book/TPDSL/Book/code/symtab/monolithic/Cymbol.g";
  }
  ...
  public final CymbolParser.type_return type() throws RecognitionException {
    ...
    try {
      ...
      System.out
          .println("line " + ((Token) retval.start).getLine() + ": ref " + retval.tsym.getName());
  ...
  public final void varDeclaration() throws RecognitionException {
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/symtab/monolithic/Cymbol.g:23:9: type ID ( '=' expression )? ';'
      {
        ...
        System.out
            .println("line " + ID1.getLine() + ": def " + (ID1 != null ? ID1.getText() : null));
        VariableSymbol vs = new VariableSymbol((ID1 != null ? ID1.getText() : null),
            (type2 != null ? type2.tsym : null));
        symtab.define(vs);
  ...
  public static final BitSet FOLLOW_varDeclaration_in_compilationUnit37 = new BitSet(
  ...
  public static final BitSet FOLLOW_type_in_varDeclaration106 = new BitSet(
      new long[]{0x0000000000000010L});
  public static final BitSet FOLLOW_ID_in_varDeclaration108 = new BitSet(
      new long[]{0x0000000000001800L});
  public static final BitSet FOLLOW_11_in_varDeclaration111 = new BitSet(
      new long[]{0x0000000000004030L});
  public static final BitSet FOLLOW_expression_in_varDeclaration113 = new BitSet(
      new long[]{0x0000000000001000L});
  public static final BitSet FOLLOW_12_in_varDeclaration117 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_primary_in_expression145 = new BitSet(
      new long[]{0x0000000000002002L});
  public static final BitSet FOLLOW_13_in_expression148 = new BitSet(
      new long[]{0x0000000000004030L});
  public static final BitSet FOLLOW_primary_in_expression150 = new BitSet(
      new long[]{0x0000000000002002L});
  ...
  public static final BitSet FOLLOW_expression_in_primary202 = new BitSet(
