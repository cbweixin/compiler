...
public class CymbolParser extends Parser {
  ...
  public static final String[] tokenNames = new String[]{
      "<invalid>", "<EOR>", "<DOWN>", "<UP>", "METHOD_DECL", "ARG_DECL", "BLOCK", "MEMBERS",
      "VAR_DECL", "FIELD_DECL", "CALL", "ELIST", "EXPR", "ASSIGN", "EXTENDS", "ID", "INT", "LETTER",
      "WS", "SL_COMMENT", "'class'", "'{'", "'}'", "';'", "':'", "'public'", "'('", "')'", "','",
      "'float'", "'int'", "'void'", "'return'", "'+'", "'.'", "'this'", "'super'"
  };
  ...
  public final CymbolParser.compilationUnit_return compilationUnit() throws RecognitionException {
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/symtab/class/Cymbol.g:22:9: ( classDefinition | varDeclaration | methodDeclaration )+ EOF
      {
          ...
          switch (alt1) {
              ...
              // /Users/parrt/research/book/TPDSL/Book/code/symtab/class/Cymbol.g:22:46: methodDeclaration
            {
              ...
              state._fsp--;
                ...
                if (state.backtracking == 0) {
                    adaptor.addChild(root_0, methodDeclaration3.getTree());
                }
        ...
        EOF4 = (Token) match(input, EOF, FOLLOW_EOF_in_compilationUnit151);
          if (state.failed) {
              return retval;
          }
        if (state.backtracking == 0) {
  ...
  public final CymbolParser.classDefinition_return classDefinition() throws RecognitionException {
    ...
    try {
      ...
      {
        string_literal5 = (Token) match(input, 20, FOLLOW_20_in_classDefinition171);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
        ...
        ID6 = (Token) match(input, ID, FOLLOW_ID_in_classDefinition173);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
        ...
        switch (alt2) {
            ...
            // /Users/parrt/research/book/TPDSL/Book/code/symtab/class/Cymbol.g:27:20: superClass
          {
            ...
            state._fsp--;
              ...
              if (state.backtracking == 0) {
                  stream_superClass.add(superClass7.getTree());
              }
        ...
        char_literal8 = (Token) match(input, 21, FOLLOW_21_in_classDefinition178);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
          ...
          switch (alt3) {
              ...
              // /Users/parrt/research/book/TPDSL/Book/code/symtab/class/Cymbol.g:27:36: classMember
            {
              ...
              state._fsp--;
                ...
                if (state.backtracking == 0) {
                    stream_classMember.add(classMember9.getTree());
                }
        ...
        char_literal10 = (Token) match(input, 22, FOLLOW_22_in_classDefinition183);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
        ...
        char_literal11 = (Token) match(input, 23, FOLLOW_23_in_classDefinition185);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
            ...
            // /Users/parrt/research/book/TPDSL/Book/code/symtab/class/Cymbol.g:28:12: ^( 'class' ID ( superClass )? ^( MEMBERS ( classMember )+ ) )
            {
              ...
              // /Users/parrt/research/book/TPDSL/Book/code/symtab/class/Cymbol.g:28:37: ^( MEMBERS ( classMember )+ )
              {
                ...
                root_2 = (CymbolAST) adaptor
                    .becomeRoot((CymbolAST) adaptor.create(MEMBERS, "MEMBERS"), root_2);
  ...
  public final CymbolParser.superClass_return superClass() throws RecognitionException {
    ...
    try {
      ...
      {
        char_literal12 = (Token) match(input, 24, FOLLOW_24_in_superClass224);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
        ...
        string_literal13 = (Token) match(input, 25, FOLLOW_25_in_superClass226);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
        ...
        ID14 = (Token) match(input, ID, FOLLOW_ID_in_superClass228);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
          ...
          // 31:20: -> ^( EXTENDS ID )
          {
            // /Users/parrt/research/book/TPDSL/Book/code/symtab/class/Cymbol.g:31:23: ^( EXTENDS ID )
            {
              ...
              root_1 = (CymbolAST) adaptor
                  .becomeRoot((CymbolAST) adaptor.create(EXTENDS, "EXTENDS"), root_1);
    ...
    try {
      ...
      switch (alt5) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/symtab/class/Cymbol.g:36:4: type ID ( '=' expression )? ';'
        {
          ...
          ID16 = (Token) match(input, ID, FOLLOW_ID_in_classMember250);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          switch (alt4) {
            ...
            {
              char_literal17 = (Token) match(input, ASSIGN, FOLLOW_ASSIGN_in_classMember253);
                if (state.failed) {
                    return retval;
                }
                if (state.backtracking == 0) {
          ...
          char_literal19 = (Token) match(input, 23, FOLLOW_23_in_classMember259);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/symtab/class/Cymbol.g:37:4: methodDeclaration
        {
          ...
          state._fsp--;
            ...
            if (state.backtracking == 0) {
                adaptor.addChild(root_0, methodDeclaration20.getTree());
            }
        ...
        {
          string_literal21 = (Token) match(input, 25, FOLLOW_25_in_classMember282);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
                stream_25.add(string_literal21);
            }

          char_literal22 = (Token) match(input, 24, FOLLOW_24_in_classMember284);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
  ...
  public final CymbolParser.methodDeclaration_return methodDeclaration()
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/symtab/class/Cymbol.g:43:9: type ID '(' ( formalParameters )? ')' block
      {
        ...
        ID24 = (Token) match(input, ID, FOLLOW_ID_in_methodDeclaration307);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
        ...
        char_literal25 = (Token) match(input, 26, FOLLOW_26_in_methodDeclaration309);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
        ...
        switch (alt6) {
            ...
            // /Users/parrt/research/book/TPDSL/Book/code/symtab/class/Cymbol.g:43:21: formalParameters
          {
            ...
            state._fsp--;
              ...
              if (state.backtracking == 0) {
                  stream_formalParameters.add(formalParameters26.getTree());
              }
        ...
        char_literal27 = (Token) match(input, 27, FOLLOW_27_in_methodDeclaration314);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
  ...
  public final CymbolParser.formalParameters_return formalParameters() throws RecognitionException {
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/symtab/class/Cymbol.g:49:9: type ID ( ',' type ID )*
      {
        ...
        ID30 = (Token) match(input, ID, FOLLOW_ID_in_formalParameters361);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
        ...
        do {
          ...
          switch (alt7) {
            ...
            {
              char_literal31 = (Token) match(input, 28, FOLLOW_28_in_formalParameters364);
                if (state.failed) {
                    return retval;
                }
                if (state.backtracking == 0) {
              ...
              ID33 = (Token) match(input, ID, FOLLOW_ID_in_formalParameters368);
                if (state.failed) {
                    return retval;
                }
                if (state.backtracking == 0) {
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/symtab/class/Cymbol.g:
      {
        ...
        if (input.LA(1) == ID || (input.LA(1) >= 29 && input.LA(1) <= 31)) {
          input.consume();
            if (state.backtracking == 0) {
                adaptor.addChild(root_0, (CymbolAST) adaptor.create(set34));
            }
  ...
  public final CymbolParser.block_return block() throws RecognitionException {
    ...
    try {
      ...
      {
        char_literal35 = (Token) match(input, 21, FOLLOW_21_in_block442);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
        ...
        do {
          ...
          if (((LA8_0 >= ID && LA8_0 <= INT) || LA8_0 == 21 || LA8_0 == 23 || LA8_0 == 26 || (
              LA8_0 >= 29 && LA8_0 <= 32) || (LA8_0 >= 35 && LA8_0 <= 36))) {
            alt8 = 1;
          }
        ...
        char_literal37 = (Token) match(input, 22, FOLLOW_22_in_block447);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
  ...
  public final CymbolParser.varDeclaration_return varDeclaration() throws RecognitionException {
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/symtab/class/Cymbol.g:66:9: type ID ( '=' expression )? ';'
      {
        ...
        ID39 = (Token) match(input, ID, FOLLOW_ID_in_varDeclaration479);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
        ...
        switch (alt9) {
          ...
          {
            char_literal40 = (Token) match(input, ASSIGN, FOLLOW_ASSIGN_in_varDeclaration482);
              if (state.failed) {
                  return retval;
              }
              if (state.backtracking == 0) {
        ...
        char_literal42 = (Token) match(input, 23, FOLLOW_23_in_varDeclaration488);
          if (state.failed) {
              return retval;
          }
          if (state.backtracking == 0) {
              stream_23.add(char_literal42);
          }
      ...
      switch (alt12) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/symtab/class/Cymbol.g:72:7: varDeclaration
        {
          ...
          state._fsp--;
            ...
            if (state.backtracking == 0) {
                adaptor.addChild(root_0, varDeclaration44.getTree());
            }
        ...
        {
          string_literal45 = (Token) match(input, 32, FOLLOW_32_in_statement539);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
                stream_32.add(string_literal45);
            }
          ...
          char_literal47 = (Token) match(input, 23, FOLLOW_23_in_statement544);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
                stream_23.add(char_literal47);
            }
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/symtab/class/Cymbol.g:74:9: postfixExpression ( '=' expression -> ^( '=' postfixExpression expression ) | -> ^( EXPR postfixExpression ) ) ';'
        {
          ...
          state._fsp--;
            ...
            if (state.backtracking == 0) {
                stream_postfixExpression.add(postfixExpression48.getTree());
            }
          ...
          switch (alt11) {
            ...
            {
              char_literal49 = (Token) match(input, ASSIGN, FOLLOW_ASSIGN_in_statement578);
                if (state.failed) {
                    return retval;
                }
                if (state.backtracking == 0) {
                    stream_ASSIGN.add(char_literal49);
                }
          ...
          char_literal51 = (Token) match(input, 23, FOLLOW_23_in_statement630);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
        ...
        {
          char_literal52 = (Token) match(input, 23, FOLLOW_23_in_statement639);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
                stream_23.add(char_literal52);
            }
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/symtab/class/Cymbol.g:83:9: expression ( ',' expression )*
        {
          ...
          do {
            ...
            switch (alt13) {
              ...
              {
                char_literal54 = (Token) match(input, 28, FOLLOW_28_in_expressionList664);
                  if (state.failed) {
                      return retval;
                  }
                  if (state.backtracking == 0) {
  ...
  public final CymbolParser.expression_return expression() throws RecognitionException {
    ...
    RewriteRuleSubtreeStream stream_addExpression = new RewriteRuleSubtreeStream(adaptor,
        "rule addExpression");
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/symtab/class/Cymbol.g:88:9: addExpression
      {
        ...
        state._fsp--;
          ...
          if (state.backtracking == 0) {
              stream_addExpression.add(addExpression56.getTree());
          }
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/symtab/class/Cymbol.g:92:4: postfixExpression ( '+' postfixExpression )*
      {
        ...
        state._fsp--;
          ...
          if (state.backtracking == 0) {
              adaptor.addChild(root_0, postfixExpression57.getTree());
          }
        ...
        do {
          ...
          switch (alt15) {
            ...
            {
              char_literal58 = (Token) match(input, 33, FOLLOW_33_in_addExpression737);
                if (state.failed) {
                    return retval;
                }
              if (state.backtracking == 0) {
              ...
              state._fsp--;
                ...
                if (state.backtracking == 0) {
                    adaptor.addChild(root_0, postfixExpression59.getTree());
                }
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/symtab/class/Cymbol.g:97:9: ( primary -> primary ) ( options {backtrack=true; } : '.' ID '(' expressionList ')' -> ^( CALL ^( '.' $postfixExpression ID ) ) | '.' ID -> ^( '.' $postfixExpression ID ) | '(' expressionList ')' -> ^( CALL $postfixExpression) )*
      {
        ...
        // /Users/parrt/research/book/TPDSL/Book/code/symtab/class/Cymbol.g:97:10: primary
        {
          ...
          state._fsp--;
            ...
            if (state.backtracking == 0) {
                stream_primary.add(primary60.getTree());
            }
        ...
        do {
          ...
          switch (alt16) {
            ...
            {
              char_literal61 = (Token) match(input, 34, FOLLOW_34_in_postfixExpression783);
                if (state.failed) {
                    return retval;
                }
                if (state.backtracking == 0) {
              ...
              ID62 = (Token) match(input, ID, FOLLOW_ID_in_postfixExpression785);
                if (state.failed) {
                    return retval;
                }
                if (state.backtracking == 0) {
              ...
              char_literal63 = (Token) match(input, 26, FOLLOW_26_in_postfixExpression787);
                if (state.failed) {
                    return retval;
                }
                if (state.backtracking == 0) {
              ...
              state._fsp--;
                ...
                if (state.backtracking == 0) {
                    stream_expressionList.add(expressionList64.getTree());
                }
              char_literal65 = (Token) match(input, 27, FOLLOW_27_in_postfixExpression791);
                if (state.failed) {
                    return retval;
                }
                if (state.backtracking == 0) {
              ...
              if (state.backtracking == 0) {
                ...
                // 99:35: -> ^( CALL ^( '.' $postfixExpression ID ) )
                {
                  // /Users/parrt/research/book/TPDSL/Book/code/symtab/class/Cymbol.g:99:38: ^( CALL ^( '.' $postfixExpression ID ) )
                  {
                    CymbolAST root_1 = (CymbolAST) adaptor.nil();
                    root_1 = (CymbolAST) adaptor
                        .becomeRoot((CymbolAST) adaptor.create(CALL, "CALL"), root_1);
            ...
            {
              char_literal66 = (Token) match(input, 34, FOLLOW_34_in_postfixExpression812);
                if (state.failed) {
                    return retval;
                }
                if (state.backtracking == 0) {
              ...
              ID67 = (Token) match(input, ID, FOLLOW_ID_in_postfixExpression814);
                if (state.failed) {
                    return retval;
                }
                if (state.backtracking == 0) {
            ...
            {
              char_literal68 = (Token) match(input, 26, FOLLOW_26_in_postfixExpression838);
                if (state.failed) {
                    return retval;
                }
                if (state.backtracking == 0) {
              ...
              state._fsp--;
                ...
                if (state.backtracking == 0) {
                    stream_expressionList.add(expressionList69.getTree());
                }
              char_literal70 = (Token) match(input, 27, FOLLOW_27_in_postfixExpression842);
                if (state.failed) {
                    return retval;
                }
                if (state.backtracking == 0) {
  ...
  public final CymbolParser.suffix_return suffix(CommonTree expr) throws RecognitionException {
    ...
    try {
      ...
      switch (alt17) {
        ...
        {
          char_literal71 = (Token) match(input, 34, FOLLOW_34_in_suffix886);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          ID72 = (Token) match(input, ID, FOLLOW_ID_in_suffix888);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          char_literal73 = (Token) match(input, 26, FOLLOW_26_in_suffix890);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          state._fsp--;
            ...
            if (state.backtracking == 0) {
                stream_expressionList.add(expressionList74.getTree());
            }
          char_literal75 = (Token) match(input, 27, FOLLOW_27_in_suffix894);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
                stream_27.add(char_literal75);
            }
        ...
        {
          char_literal76 = (Token) match(input, 34, FOLLOW_34_in_suffix913);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          ID77 = (Token) match(input, ID, FOLLOW_ID_in_suffix915);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
        ...
        {
          char_literal78 = (Token) match(input, 26, FOLLOW_26_in_suffix937);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
          ...
          char_literal80 = (Token) match(input, 27, FOLLOW_27_in_suffix941);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
    ...
    try {
      ...
      switch (alt18) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/symtab/class/Cymbol.g:114:9: 'this'
        {
          ...
          string_literal81 = (Token) match(input, 35, FOLLOW_35_in_primary973);
            if (state.failed) {
                return retval;
            }
          if (state.backtracking == 0) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/symtab/class/Cymbol.g:115:7: 'super'
        {
          ...
          string_literal82 = (Token) match(input, 36, FOLLOW_36_in_primary981);
            if (state.failed) {
                return retval;
            }
          if (state.backtracking == 0) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/symtab/class/Cymbol.g:116:7: ID
        {
          ...
          ID83 = (Token) match(input, ID, FOLLOW_ID_in_primary989);
            if (state.failed) {
                return retval;
            }
          if (state.backtracking == 0) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/symtab/class/Cymbol.g:117:9: INT
        {
          ...
          INT84 = (Token) match(input, INT, FOLLOW_INT_in_primary999);
            if (state.failed) {
                return retval;
            }
          if (state.backtracking == 0) {
        ...
        {
          char_literal85 = (Token) match(input, 26, FOLLOW_26_in_primary1009);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
                stream_26.add(char_literal85);
            }
          ...
          char_literal87 = (Token) match(input, 27, FOLLOW_27_in_primary1013);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 0) {
  ...
  public final void synpred1_Cymbol_fragment() throws RecognitionException {
    ...
    // /Users/parrt/research/book/TPDSL/Book/code/symtab/class/Cymbol.g:99:5: '.' ID '(' expressionList ')'
    {
      match(input, 34, FOLLOW_34_in_synpred1_Cymbol783);
        if (state.failed) {
            return;
        }
      match(input, ID, FOLLOW_ID_in_synpred1_Cymbol785);
        if (state.failed) {
            return;
        }
      match(input, 26, FOLLOW_26_in_synpred1_Cymbol787);
        if (state.failed) {
            return;
        }
      ...
      match(input, 27, FOLLOW_27_in_synpred1_Cymbol791);
        if (state.failed) {
            return;
        }
  ...
  public final void synpred2_Cymbol_fragment() throws RecognitionException {
    ...
    // /Users/parrt/research/book/TPDSL/Book/code/symtab/class/Cymbol.g:100:5: '.' ID
    {
      match(input, 34, FOLLOW_34_in_synpred2_Cymbol812);
        if (state.failed) {
            return;
        }
      match(input, ID, FOLLOW_ID_in_synpred2_Cymbol814);
        if (state.failed) {
            return;
        }
  ...
  public static final BitSet FOLLOW_classDefinition_in_compilationUnit138 = new BitSet(
      new long[]{0x00000000E0108000L});
  public static final BitSet FOLLOW_varDeclaration_in_compilationUnit142 = new BitSet(
      new long[]{0x00000000E0108000L});
  public static final BitSet FOLLOW_methodDeclaration_in_compilationUnit146 = new BitSet(
      new long[]{0x00000000E0108000L});
  public static final BitSet FOLLOW_EOF_in_compilationUnit151 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_20_in_classDefinition171 = new BitSet(
      new long[]{0x0000000000008000L});
  public static final BitSet FOLLOW_ID_in_classDefinition173 = new BitSet(
      new long[]{0x0000000001200000L});
  public static final BitSet FOLLOW_superClass_in_classDefinition175 = new BitSet(
      new long[]{0x0000000000200000L});
  public static final BitSet FOLLOW_21_in_classDefinition178 = new BitSet(
      new long[]{0x00000000E2108000L});
  public static final BitSet FOLLOW_classMember_in_classDefinition180 = new BitSet(
      new long[]{0x00000000E2508000L});
  public static final BitSet FOLLOW_22_in_classDefinition183 = new BitSet(
      new long[]{0x0000000000800000L});
  public static final BitSet FOLLOW_23_in_classDefinition185 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_24_in_superClass224 = new BitSet(
      new long[]{0x0000000002000000L});
  public static final BitSet FOLLOW_25_in_superClass226 = new BitSet(
      new long[]{0x0000000000008000L});
  public static final BitSet FOLLOW_ID_in_superClass228 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_type_in_classMember248 = new BitSet(
      new long[]{0x0000000000008000L});
  public static final BitSet FOLLOW_ID_in_classMember250 = new BitSet(
      new long[]{0x0000000000802000L});
  public static final BitSet FOLLOW_ASSIGN_in_classMember253 = new BitSet(
      new long[]{0x0000001804018000L});
  public static final BitSet FOLLOW_expression_in_classMember255 = new BitSet(
      new long[]{0x0000000000800000L});
  public static final BitSet FOLLOW_23_in_classMember259 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_methodDeclaration_in_classMember277 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_25_in_classMember282 = new BitSet(
      new long[]{0x0000000001000000L});
  public static final BitSet FOLLOW_24_in_classMember284 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_type_in_methodDeclaration305 = new BitSet(
      new long[]{0x0000000000008000L});
  public static final BitSet FOLLOW_ID_in_methodDeclaration307 = new BitSet(
      new long[]{0x0000000004000000L});
  public static final BitSet FOLLOW_26_in_methodDeclaration309 = new BitSet(
      new long[]{0x00000000E8008000L});
  public static final BitSet FOLLOW_formalParameters_in_methodDeclaration311 = new BitSet(
      new long[]{0x0000000008000000L});
  public static final BitSet FOLLOW_27_in_methodDeclaration314 = new BitSet(
      new long[]{0x0000000000200000L});
  public static final BitSet FOLLOW_block_in_methodDeclaration316 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_type_in_formalParameters359 = new BitSet(
      new long[]{0x0000000000008000L});
  public static final BitSet FOLLOW_ID_in_formalParameters361 = new BitSet(
      new long[]{0x0000000010000002L});
  public static final BitSet FOLLOW_28_in_formalParameters364 = new BitSet(
      new long[]{0x00000000E0008000L});
  public static final BitSet FOLLOW_type_in_formalParameters366 = new BitSet(
      new long[]{0x0000000000008000L});
  public static final BitSet FOLLOW_ID_in_formalParameters368 = new BitSet(
      new long[]{0x0000000010000002L});
  public static final BitSet FOLLOW_set_in_type0 = new BitSet(new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_21_in_block442 = new BitSet(new long[]{0x00000019E4E18000L});
  public static final BitSet FOLLOW_statement_in_block444 = new BitSet(
      new long[]{0x00000019E4E18000L});
  public static final BitSet FOLLOW_22_in_block447 = new BitSet(new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_type_in_varDeclaration477 = new BitSet(
      new long[]{0x0000000000008000L});
  public static final BitSet FOLLOW_ID_in_varDeclaration479 = new BitSet(
      new long[]{0x0000000000802000L});
  public static final BitSet FOLLOW_ASSIGN_in_varDeclaration482 = new BitSet(
      new long[]{0x0000001804018000L});
  public static final BitSet FOLLOW_expression_in_varDeclaration484 = new BitSet(
      new long[]{0x0000000000800000L});
  public static final BitSet FOLLOW_23_in_varDeclaration488 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_block_in_statement521 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_varDeclaration_in_statement529 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_32_in_statement539 = new BitSet(
      new long[]{0x0000001804818000L});
  public static final BitSet FOLLOW_expression_in_statement541 = new BitSet(
      new long[]{0x0000000000800000L});
  public static final BitSet FOLLOW_23_in_statement544 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_postfixExpression_in_statement563 = new BitSet(
      new long[]{0x0000000000802000L});
  public static final BitSet FOLLOW_ASSIGN_in_statement578 = new BitSet(
      new long[]{0x0000001804018000L});
  public static final BitSet FOLLOW_expression_in_statement580 = new BitSet(
      new long[]{0x0000000000800000L});
  public static final BitSet FOLLOW_23_in_statement630 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_23_in_statement639 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_expression_in_expressionList661 = new BitSet(
      new long[]{0x0000000010000002L});
  public static final BitSet FOLLOW_28_in_expressionList664 = new BitSet(
      new long[]{0x0000001804018000L});
  public static final BitSet FOLLOW_expression_in_expressionList666 = new BitSet(
      new long[]{0x0000000010000002L});
  public static final BitSet FOLLOW_addExpression_in_expression708 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_postfixExpression_in_addExpression734 = new BitSet(
      new long[]{0x0000000200000002L});
  public static final BitSet FOLLOW_33_in_addExpression737 = new BitSet(
      new long[]{0x0000001804018000L});
  public static final BitSet FOLLOW_postfixExpression_in_addExpression740 = new BitSet(
      new long[]{0x0000000200000002L});
  public static final BitSet FOLLOW_primary_in_postfixExpression760 = new BitSet(
      new long[]{0x0000000404000002L});
  public static final BitSet FOLLOW_34_in_postfixExpression783 = new BitSet(
      new long[]{0x0000000000008000L});
  public static final BitSet FOLLOW_ID_in_postfixExpression785 = new BitSet(
      new long[]{0x0000000004000000L});
  public static final BitSet FOLLOW_26_in_postfixExpression787 = new BitSet(
      new long[]{0x000000180C018000L});
  public static final BitSet FOLLOW_expressionList_in_postfixExpression789 = new BitSet(
      new long[]{0x0000000008000000L});
  public static final BitSet FOLLOW_27_in_postfixExpression791 = new BitSet(
      new long[]{0x0000000404000002L});
  public static final BitSet FOLLOW_34_in_postfixExpression812 = new BitSet(
      new long[]{0x0000000000008000L});
  public static final BitSet FOLLOW_ID_in_postfixExpression814 = new BitSet(
      new long[]{0x0000000404000002L});
  public static final BitSet FOLLOW_26_in_postfixExpression838 = new BitSet(
      new long[]{0x000000180C018000L});
  public static final BitSet FOLLOW_expressionList_in_postfixExpression840 = new BitSet(
      new long[]{0x0000000008000000L});
  public static final BitSet FOLLOW_27_in_postfixExpression842 = new BitSet(
      new long[]{0x0000000404000002L});
  ...
  public static final BitSet FOLLOW_expressionList_in_suffix892 = new BitSet(
      new long[]{0x0000000008000000L});
  ...
  public static final BitSet FOLLOW_expressionList_in_suffix939 = new BitSet(
      new long[]{0x0000000008000000L});
  ...
  public static final BitSet FOLLOW_expression_in_primary1011 = new BitSet(
      new long[]{0x0000000008000000L});
  public static final BitSet FOLLOW_27_in_primary1013 = new BitSet(new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_34_in_synpred1_Cymbol783 = new BitSet(
      new long[]{0x0000000000008000L});
  public static final BitSet FOLLOW_ID_in_synpred1_Cymbol785 = new BitSet(
      new long[]{0x0000000004000000L});
  public static final BitSet FOLLOW_26_in_synpred1_Cymbol787 = new BitSet(
      new long[]{0x000000180C018000L});
  public static final BitSet FOLLOW_expressionList_in_synpred1_Cymbol789 = new BitSet(
      new long[]{0x0000000008000000L});
  public static final BitSet FOLLOW_27_in_synpred1_Cymbol791 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_34_in_synpred2_Cymbol812 = new BitSet(
      new long[]{0x0000000000008000L});
  public static final BitSet FOLLOW_ID_in_synpred2_Cymbol814 = new BitSet(
      new long[]{0x0000000000000002L});
