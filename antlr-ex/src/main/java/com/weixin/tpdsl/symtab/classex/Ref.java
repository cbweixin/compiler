...
public class Ref extends TreeFilter {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/symtab/class/Ref.g:33:9: ^( 'class' name= ID ( ^( EXTENDS sup= ID ) )? ^( MEMBERS ( . )* ) )
      {
        ...
        if (state.backtracking == 1) {
          ...
          if (sup != null) {
            ...
            System.out.println(
                "line " + name.getLine() + ": set " + (name != null ? name.getText() : null) +
  ...
  public final Ref.type_return type() throws RecognitionException {
    ...
    ((CymbolAST) retval.start).symbol = ((CymbolAST) retval.start).scope
        .resolve(((CymbolAST) retval.start).getText());
  ...
  public static final BitSet FOLLOW_enterMethod_in_topdown58 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_enterClass_in_topdown68 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_varDeclaration_in_topdown78 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_assignment_in_topdown88 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_resolveExpr_in_topdown98 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_20_in_enterClass121 = new BitSet(
      new long[]{0x0000000000000004L});
  public static final BitSet FOLLOW_ID_in_enterClass125 = new BitSet(
      new long[]{0x0000000000004080L});
  public static final BitSet FOLLOW_EXTENDS_in_enterClass129 = new BitSet(
      new long[]{0x0000000000000004L});
  public static final BitSet FOLLOW_ID_in_enterClass133 = new BitSet(
      new long[]{0x0000000000000008L});
  public static final BitSet FOLLOW_MEMBERS_in_enterClass139 = new BitSet(
      new long[]{0x0000000000000004L});
  public static final BitSet FOLLOW_METHOD_DECL_in_enterMethod175 = new BitSet(
      new long[]{0x0000000000000004L});
  public static final BitSet FOLLOW_type_in_enterMethod177 = new BitSet(
      new long[]{0x0000000000008000L});
  public static final BitSet FOLLOW_ID_in_enterMethod179 = new BitSet(
      new long[]{0x0000001FFFFFFFF8L});
  public static final BitSet FOLLOW_set_in_varDeclaration218 = new BitSet(
      new long[]{0x0000000000000004L});
  public static final BitSet FOLLOW_type_in_varDeclaration226 = new BitSet(
      new long[]{0x0000000000008000L});
  public static final BitSet FOLLOW_ID_in_varDeclaration228 = new BitSet(
      new long[]{0x0000001FFFFFFFF8L});
  public static final BitSet FOLLOW_set_in_type0 = new BitSet(new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_ASSIGN_in_assignment321 = new BitSet(
      new long[]{0x0000000000000004L});
  public static final BitSet FOLLOW_expr_in_assignment323 = new BitSet(
      new long[]{0x0000000E00018400L});
  public static final BitSet FOLLOW_expr_in_assignment325 = new BitSet(
      new long[]{0x0000000000000008L});
  public static final BitSet FOLLOW_EXPR_in_resolveExpr337 = new BitSet(
      new long[]{0x0000000000000004L});
  public static final BitSet FOLLOW_expr_in_resolveExpr339 = new BitSet(
      new long[]{0x0000000000000008L});
