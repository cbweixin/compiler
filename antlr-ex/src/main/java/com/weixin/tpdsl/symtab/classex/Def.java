...
public class Def extends TreeFilter {
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/symtab/class/Def.g:72:9: ^( METHOD_DECL type= . ID ( . )* )
      {
        ...
        if (state.backtracking == 1) {
          ...
          System.out.println(
              "line " + ID1.getLine() + ": def method " + (ID1 != null ? ID1.getText() : null));
          type.scope = currentScope;
          MethodSymbol ms = new MethodSymbol((ID1 != null ? ID1.getText() : null), null,
              currentScope);
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/symtab/class/Def.g:102:9: ^( ( FIELD_DECL | VAR_DECL | ARG_DECL ) type= . ID ( . )? )
      {
        ...
        if (state.backtracking == 1) {
          ...
          System.out
              .println("line " + ID2.getLine() + ": def " + (ID2 != null ? ID2.getText() : null));
          type.scope = currentScope;
  ...
  public static final BitSet FOLLOW_varDeclaration_in_topdown86 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_atoms_in_topdown96 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_exitBlock_in_bottomup115 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_exitMethod_in_bottomup125 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_exitClass_in_bottomup135 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_BLOCK_in_enterBlock156 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_BLOCK_in_exitBlock177 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_20_in_enterClass208 = new BitSet(
      new long[]{0x0000000000000004L});
  public static final BitSet FOLLOW_ID_in_enterClass212 = new BitSet(
      new long[]{0x0000001FFFFFFFF0L});
  public static final BitSet FOLLOW_EXTENDS_in_enterClass216 = new BitSet(
      new long[]{0x0000000000000004L});
  public static final BitSet FOLLOW_ID_in_enterClass220 = new BitSet(
      new long[]{0x0000000000000008L});
  public static final BitSet FOLLOW_20_in_exitClass256 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_METHOD_DECL_in_enterMethod286 = new BitSet(
      new long[]{0x0000000000000004L});
  public static final BitSet FOLLOW_ID_in_enterMethod292 = new BitSet(
      new long[]{0x0000001FFFFFFFF8L});
  public static final BitSet FOLLOW_METHOD_DECL_in_exitMethod325 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_set_in_atoms363 = new BitSet(new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_set_in_varDeclaration399 = new BitSet(
      new long[]{0x0000000000000004L});
  public static final BitSet FOLLOW_ID_in_varDeclaration411 = new BitSet(
      new long[]{0x0000001FFFFFFFF8L});
