...
public class CymbolParser extends Parser {
  ...
  public static final String[] tokenNames = new String[]{
      ...
      "FIELD_DECL", "CALL", "ELIST", "EXPR", "ID", "INT", "LETTER", "WS", "SL_COMMENT", "'struct'",
  ...
  public String getGrammarFileName() {
    return "/Users/parrt/research/book/TPDSL/Book/code/symtab/aggr/Cymbol.g";
  }
  ...
  public final CymbolParser.structDeclaration_return structDeclaration()
    ...
    try {
      ...
      {
        string_literal4 = (Token) match(input, 17, FOLLOW_17_in_structDeclaration163);
        if (state.failed) {
          return retval;
        }
        if (state.backtracking == 0) {
        ...
        ID5 = (Token) match(input, ID, FOLLOW_ID_in_structDeclaration165);
        if (state.failed) {
          return retval;
        }
        if (state.backtracking == 0) {
        ...
        char_literal6 = (Token) match(input, 18, FOLLOW_18_in_structDeclaration167);
        if (state.failed) {
          return retval;
        }
        if (state.backtracking == 0) {
        ...
        char_literal8 = (Token) match(input, 19, FOLLOW_19_in_structDeclaration172);
        if (state.failed) {
          return retval;
        }
        if (state.backtracking == 0) {
        ...
        char_literal9 = (Token) match(input, 20, FOLLOW_20_in_structDeclaration174);
        if (state.failed) {
          return retval;
        }
        if (state.backtracking == 0) {
    ...
    try {
      ...
      switch (alt3) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/symtab/aggr/Cymbol.g:30:4: type ID ';'
        {
          ...
          ID11 = (Token) match(input, ID, FOLLOW_ID_in_structMember200);
          if (state.failed) {
            return retval;
          }
          if (state.backtracking == 0) {
          ...
          char_literal12 = (Token) match(input, 20, FOLLOW_20_in_structMember202);
          if (state.failed) {
            return retval;
          }
          if (state.backtracking == 0) {
            ...
            // 30:16: -> ^( FIELD_DECL type ID )
            {
              // /Users/parrt/research/book/TPDSL/Book/code/symtab/aggr/Cymbol.g:30:19: ^( FIELD_DECL type ID )
              {
                ...
                root_1 = (CommonTree) adaptor
                    .becomeRoot((CommonTree) adaptor.create(FIELD_DECL, "FIELD_DECL"), root_1);
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/symtab/aggr/Cymbol.g:31:4: structDeclaration
        {
          ...
          if (state.backtracking == 0) {
            adaptor.addChild(root_0, structDeclaration13.getTree());
          }
  ...
  public final CymbolParser.methodDeclaration_return methodDeclaration()
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/symtab/aggr/Cymbol.g:36:9: type ID '(' ( formalParameters )? ')' block
      {
        ...
        ID15 = (Token) match(input, ID, FOLLOW_ID_in_methodDeclaration237);
        if (state.failed) {
          return retval;
        }
        if (state.backtracking == 0) {
        ...
        char_literal16 = (Token) match(input, 21, FOLLOW_21_in_methodDeclaration239);
        if (state.failed) {
          return retval;
        }
        if (state.backtracking == 0) {
        ...
        switch (alt4) {
            ...
            // /Users/parrt/research/book/TPDSL/Book/code/symtab/aggr/Cymbol.g:36:21: formalParameters
          {
            ...
            if (state.backtracking == 0) {
              stream_formalParameters.add(formalParameters17.getTree());
            }
        ...
        char_literal18 = (Token) match(input, 22, FOLLOW_22_in_methodDeclaration244);
        if (state.failed) {
          return retval;
        }
        if (state.backtracking == 0) {
        ...
        if (state.backtracking == 0) {
          stream_block.add(block19.getTree());
        }
        ...
        if (state.backtracking == 0) {
          ...
          // 37:9: -> ^( METHOD_DECL type ID ( formalParameters )? block )
          {
            // /Users/parrt/research/book/TPDSL/Book/code/symtab/aggr/Cymbol.g:37:12: ^( METHOD_DECL type ID ( formalParameters )? block )
            {
              CommonTree root_1 = (CommonTree) adaptor.nil();
              root_1 = (CommonTree) adaptor
                  .becomeRoot((CommonTree) adaptor.create(METHOD_DECL, "METHOD_DECL"), root_1);
  ...
  public final CymbolParser.formalParameters_return formalParameters() throws RecognitionException {
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/symtab/aggr/Cymbol.g:42:9: type ID ( ',' type ID )*
      {
        ...
        ID21 = (Token) match(input, ID, FOLLOW_ID_in_formalParameters291);
        if (state.failed) {
          return retval;
        }
        if (state.backtracking == 0) {
        ...
        do {
          ...
          switch (alt5) {
            ...
            {
              char_literal22 = (Token) match(input, 23, FOLLOW_23_in_formalParameters294);
              if (state.failed) {
                return retval;
              }
              if (state.backtracking == 0) {
              ...
              ID24 = (Token) match(input, ID, FOLLOW_ID_in_formalParameters298);
              if (state.failed) {
                return retval;
              }
              if (state.backtracking == 0) {
          ...
          // 42:32: -> ( ^( ARG_DECL type ID ) )+
          {
            ...
            while (stream_type.hasNext() || stream_ID.hasNext()) {
              // /Users/parrt/research/book/TPDSL/Book/code/symtab/aggr/Cymbol.g:42:35: ^( ARG_DECL type ID )
              {
                CommonTree root_1 = (CommonTree) adaptor.nil();
                root_1 = (CommonTree) adaptor
                    .becomeRoot((CommonTree) adaptor.create(ARG_DECL, "ARG_DECL"), root_1);
  ...
  public final CymbolParser.block_return block() throws RecognitionException {
    ...
    try {
      ...
      {
        char_literal26 = (Token) match(input, 18, FOLLOW_18_in_block372);
        if (state.failed) {
          return retval;
        }
        if (state.backtracking == 0) {
        ...
        do {
          ...
          if (((LA6_0 >= ID && LA6_0 <= INT) || (LA6_0 >= 17 && LA6_0 <= 18) || LA6_0 == 21 || (
              LA6_0 >= 24 && LA6_0 <= 26) || LA6_0 == 28)) {
            alt6 = 1;
          }
          ...
          switch (alt6) {
              ...
              // /Users/parrt/research/book/TPDSL/Book/code/symtab/aggr/Cymbol.g:53:13: statement
            {
              ...
              if (state.backtracking == 0) {
                stream_statement.add(statement27.getTree());
              }
        ...
        char_literal28 = (Token) match(input, 19, FOLLOW_19_in_block377);
        if (state.failed) {
          return retval;
        }
        if (state.backtracking == 0) {
        ...
        if (state.backtracking == 0) {
          ...
          // 53:28: -> ^( BLOCK ( statement )* )
          {
            // /Users/parrt/research/book/TPDSL/Book/code/symtab/aggr/Cymbol.g:53:31: ^( BLOCK ( statement )* )
            {
              CommonTree root_1 = (CommonTree) adaptor.nil();
              root_1 = (CommonTree) adaptor
                  .becomeRoot((CommonTree) adaptor.create(BLOCK, "BLOCK"), root_1);
  ...
  public final CymbolParser.varDeclaration_return varDeclaration() throws RecognitionException {
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/symtab/aggr/Cymbol.g:59:9: type ID ( '=' expression )? ';'
      {
        ...
        ID30 = (Token) match(input, ID, FOLLOW_ID_in_varDeclaration409);
        if (state.failed) {
          return retval;
        }
        if (state.backtracking == 0) {
        ...
        switch (alt7) {
          ...
          {
            char_literal31 = (Token) match(input, 27, FOLLOW_27_in_varDeclaration412);
            if (state.failed) {
              return retval;
            }
            if (state.backtracking == 0) {
        ...
        char_literal33 = (Token) match(input, 20, FOLLOW_20_in_varDeclaration418);
        if (state.failed) {
          return retval;
        }
        if (state.backtracking == 0) {
        ...
        if (state.backtracking == 0) {
          ...
          // 59:39: -> ^( VAR_DECL type ID ( expression )? )
          {
            // /Users/parrt/research/book/TPDSL/Book/code/symtab/aggr/Cymbol.g:59:42: ^( VAR_DECL type ID ( expression )? )
            {
              CommonTree root_1 = (CommonTree) adaptor.nil();
              root_1 = (CommonTree) adaptor
                  .becomeRoot((CommonTree) adaptor.create(VAR_DECL, "VAR_DECL"), root_1);
    ...
    try {
      ...
      switch (alt10) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/symtab/aggr/Cymbol.g:66:7: structDeclaration
        {
          ...
          if (state.backtracking == 0) {
            adaptor.addChild(root_0, structDeclaration35.getTree());
          }
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/symtab/aggr/Cymbol.g:67:7: varDeclaration
        {
          ...
          if (state.backtracking == 0) {
            adaptor.addChild(root_0, varDeclaration36.getTree());
          }
        ...
        {
          string_literal37 = (Token) match(input, 28, FOLLOW_28_in_statement485);
          if (state.failed) {
            return retval;
          }
          if (state.backtracking == 0) {
            stream_28.add(string_literal37);
          }
          ...
          char_literal39 = (Token) match(input, 20, FOLLOW_20_in_statement490);
          if (state.failed) {
            return retval;
          }
          if (state.backtracking == 0) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/symtab/aggr/Cymbol.g:69:9: postfixExpression ( '=' expression -> ^( '=' postfixExpression expression ) | -> ^( EXPR postfixExpression ) ) ';'
        {
          ...
          if (state.backtracking == 0) {
            stream_postfixExpression.add(postfixExpression40.getTree());
          }
          ...
          switch (alt9) {
            ...
            {
              char_literal41 = (Token) match(input, 27, FOLLOW_27_in_statement524);
              if (state.failed) {
                return retval;
              }
              if (state.backtracking == 0) {
              ...
              if (state.backtracking == 0) {
                ...
                // 71:13: -> ^( EXPR postfixExpression )
                {
                  // /Users/parrt/research/book/TPDSL/Book/code/symtab/aggr/Cymbol.g:71:16: ^( EXPR postfixExpression )
                  {
                    CommonTree root_1 = (CommonTree) adaptor.nil();
                    root_1 = (CommonTree) adaptor
                        .becomeRoot((CommonTree) adaptor.create(EXPR, "EXPR"), root_1);
          ...
          char_literal43 = (Token) match(input, 20, FOLLOW_20_in_statement576);
          if (state.failed) {
            return retval;
          }
          if (state.backtracking == 0) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/symtab/aggr/Cymbol.g:77:9: expression ( ',' expression )*
        {
          ...
          do {
            ...
            switch (alt11) {
              ...
              {
                char_literal45 = (Token) match(input, 23, FOLLOW_23_in_expressionList605);
                if (state.failed) {
                  return retval;
                }
                if (state.backtracking == 0) {
                  stream_23.add(char_literal45);
                }
          ...
          if (state.backtracking == 0) {
            ...
            // 77:38: -> ^( ELIST ( expression )+ )
            {
              // /Users/parrt/research/book/TPDSL/Book/code/symtab/aggr/Cymbol.g:77:41: ^( ELIST ( expression )+ )
              {
                CommonTree root_1 = (CommonTree) adaptor.nil();
                root_1 = (CommonTree) adaptor
                    .becomeRoot((CommonTree) adaptor.create(ELIST, "ELIST"), root_1);
  ...
  public final CymbolParser.expression_return expression() throws RecognitionException {
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/symtab/aggr/Cymbol.g:82:9: addExpression
      {
        ...
        if (state.backtracking == 0) {
          stream_addExpression.add(addExpression47.getTree());
        }
  ...
  public final CymbolParser.addExpression_return addExpression() throws RecognitionException {
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/symtab/aggr/Cymbol.g:86:4: postfixExpression ( '+' postfixExpression )*
      {
        ...
        if (state.backtracking == 0) {
          adaptor.addChild(root_0, postfixExpression48.getTree());
        }
        ...
        do {
          ...
          switch (alt13) {
            ...
            {
              char_literal49 = (Token) match(input, 29, FOLLOW_29_in_addExpression678);
              if (state.failed) {
                return retval;
              }
              if (state.backtracking == 0) {
              ...
              if (state.backtracking == 0) {
                adaptor.addChild(root_0, postfixExpression50.getTree());
              }
  ...
  public final CymbolParser.postfixExpression_return postfixExpression()
    ...
    try {
      ...
      // /Users/parrt/research/book/TPDSL/Book/code/symtab/aggr/Cymbol.g:91:9: primary (lp= '(' expressionList ')' | '.' ID )*
      {
        ...
        if (state.backtracking == 0) {
          adaptor.addChild(root_0, primary51.getTree());
        }
        ...
        do {
          ...
          switch (alt14) {
            ...
            {
              lp = (Token) match(input, 21, FOLLOW_21_in_postfixExpression711);
              if (state.failed) {
                return retval;
              }
              if (state.backtracking == 0) {
              ...
              char_literal53 = (Token) match(input, 22, FOLLOW_22_in_postfixExpression716);
              if (state.failed) {
                return retval;
              }
              if (state.backtracking == 0) {
            ...
            {
              char_literal54 = (Token) match(input, 30, FOLLOW_30_in_postfixExpression728);
              if (state.failed) {
                return retval;
              }
              if (state.backtracking == 0) {
              ...
              ID55 = (Token) match(input, ID, FOLLOW_ID_in_postfixExpression731);
              if (state.failed) {
                return retval;
              }
              if (state.backtracking == 0) {
    ...
    try {
      ...
      switch (alt15) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/symtab/aggr/Cymbol.g:99:9: ID
        {
          ...
          ID56 = (Token) match(input, ID, FOLLOW_ID_in_primary759);
          if (state.failed) {
            return retval;
          }
          if (state.backtracking == 0) {
          ...
          // /Users/parrt/research/book/TPDSL/Book/code/symtab/aggr/Cymbol.g:100:9: INT
        {
          ...
          INT57 = (Token) match(input, INT, FOLLOW_INT_in_primary769);
          if (state.failed) {
            return retval;
          }
          if (state.backtracking == 0) {
        ...
        {
          char_literal58 = (Token) match(input, 21, FOLLOW_21_in_primary779);
          if (state.failed) {
            return retval;
          }
          if (state.backtracking == 0) {
            stream_21.add(char_literal58);
          }
          ...
          char_literal60 = (Token) match(input, 22, FOLLOW_22_in_primary783);
          if (state.failed) {
            return retval;
          }
          if (state.backtracking == 0) {
            stream_22.add(char_literal60);
          }
  ...
  public static final BitSet FOLLOW_structDeclaration_in_compilationUnit136 = new BitSet(
      new long[]{0x0000000007021002L});
  public static final BitSet FOLLOW_methodDeclaration_in_compilationUnit140 = new BitSet(
      new long[]{0x0000000007021002L});
  public static final BitSet FOLLOW_varDeclaration_in_compilationUnit144 = new BitSet(
      new long[]{0x0000000007021002L});
  public static final BitSet FOLLOW_17_in_structDeclaration163 = new BitSet(
      new long[]{0x0000000000001000L});
  public static final BitSet FOLLOW_ID_in_structDeclaration165 = new BitSet(
      new long[]{0x0000000000040000L});
  public static final BitSet FOLLOW_18_in_structDeclaration167 = new BitSet(
      new long[]{0x0000000007021000L});
  public static final BitSet FOLLOW_structMember_in_structDeclaration169 = new BitSet(
      new long[]{0x00000000070A1000L});
  public static final BitSet FOLLOW_19_in_structDeclaration172 = new BitSet(
      new long[]{0x0000000000100000L});
  public static final BitSet FOLLOW_20_in_structDeclaration174 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_type_in_structMember198 = new BitSet(
      new long[]{0x0000000000001000L});
  public static final BitSet FOLLOW_ID_in_structMember200 = new BitSet(
      new long[]{0x0000000000100000L});
  public static final BitSet FOLLOW_20_in_structMember202 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_structDeclaration_in_structMember217 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_type_in_methodDeclaration235 = new BitSet(
      new long[]{0x0000000000001000L});
  public static final BitSet FOLLOW_ID_in_methodDeclaration237 = new BitSet(
      new long[]{0x0000000000200000L});
  public static final BitSet FOLLOW_21_in_methodDeclaration239 = new BitSet(
      new long[]{0x0000000007401000L});
  public static final BitSet FOLLOW_formalParameters_in_methodDeclaration241 = new BitSet(
      new long[]{0x0000000000400000L});
  public static final BitSet FOLLOW_22_in_methodDeclaration244 = new BitSet(
      new long[]{0x0000000000040000L});
  public static final BitSet FOLLOW_block_in_methodDeclaration246 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_type_in_formalParameters289 = new BitSet(
      new long[]{0x0000000000001000L});
  public static final BitSet FOLLOW_ID_in_formalParameters291 = new BitSet(
      new long[]{0x0000000000800002L});
  public static final BitSet FOLLOW_23_in_formalParameters294 = new BitSet(
      new long[]{0x0000000007001000L});
  public static final BitSet FOLLOW_type_in_formalParameters296 = new BitSet(
      new long[]{0x0000000000001000L});
  public static final BitSet FOLLOW_ID_in_formalParameters298 = new BitSet(
      new long[]{0x0000000000800002L});
  public static final BitSet FOLLOW_set_in_type0 = new BitSet(new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_18_in_block372 = new BitSet(new long[]{0x00000000172E3000L});
  public static final BitSet FOLLOW_statement_in_block374 = new BitSet(
      new long[]{0x00000000172E3000L});
  public static final BitSet FOLLOW_19_in_block377 = new BitSet(new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_type_in_varDeclaration407 = new BitSet(
      new long[]{0x0000000000001000L});
  public static final BitSet FOLLOW_ID_in_varDeclaration409 = new BitSet(
      new long[]{0x0000000008100000L});
  public static final BitSet FOLLOW_27_in_varDeclaration412 = new BitSet(
      new long[]{0x0000000017263000L});
  public static final BitSet FOLLOW_expression_in_varDeclaration414 = new BitSet(
      new long[]{0x0000000000100000L});
  public static final BitSet FOLLOW_20_in_varDeclaration418 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_block_in_statement459 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_structDeclaration_in_statement467 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_varDeclaration_in_statement475 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_28_in_statement485 = new BitSet(
      new long[]{0x0000000017363000L});
  public static final BitSet FOLLOW_expression_in_statement487 = new BitSet(
      new long[]{0x0000000000100000L});
  public static final BitSet FOLLOW_20_in_statement490 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_postfixExpression_in_statement509 = new BitSet(
      new long[]{0x0000000008100000L});
  public static final BitSet FOLLOW_27_in_statement524 = new BitSet(
      new long[]{0x0000000017263000L});
  public static final BitSet FOLLOW_expression_in_statement526 = new BitSet(
      new long[]{0x0000000000100000L});
  public static final BitSet FOLLOW_20_in_statement576 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_expression_in_expressionList602 = new BitSet(
      new long[]{0x0000000000800002L});
  public static final BitSet FOLLOW_23_in_expressionList605 = new BitSet(
      new long[]{0x0000000017263000L});
  public static final BitSet FOLLOW_expression_in_expressionList607 = new BitSet(
      new long[]{0x0000000000800002L});
  public static final BitSet FOLLOW_addExpression_in_expression649 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_postfixExpression_in_addExpression675 = new BitSet(
      new long[]{0x0000000020000002L});
  public static final BitSet FOLLOW_29_in_addExpression678 = new BitSet(
      new long[]{0x0000000017263000L});
  public static final BitSet FOLLOW_postfixExpression_in_addExpression681 = new BitSet(
      new long[]{0x0000000020000002L});
  public static final BitSet FOLLOW_primary_in_postfixExpression700 = new BitSet(
      new long[]{0x0000000040200002L});
  public static final BitSet FOLLOW_21_in_postfixExpression711 = new BitSet(
      new long[]{0x0000000017663000L});
  public static final BitSet FOLLOW_expressionList_in_postfixExpression714 = new BitSet(
      new long[]{0x0000000000400000L});
  public static final BitSet FOLLOW_22_in_postfixExpression716 = new BitSet(
      new long[]{0x0000000040200002L});
  public static final BitSet FOLLOW_30_in_postfixExpression728 = new BitSet(
      new long[]{0x0000000000001000L});
  public static final BitSet FOLLOW_ID_in_postfixExpression731 = new BitSet(
      new long[]{0x0000000040200002L});
  ...
  public static final BitSet FOLLOW_expression_in_primary781 = new BitSet(
      new long[]{0x0000000000400000L});
