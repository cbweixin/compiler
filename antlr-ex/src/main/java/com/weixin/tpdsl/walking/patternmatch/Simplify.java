...
public class Simplify extends TreeRewriter {
      ...
      // Simplify.g:11:11: scalarVectorMult
      {
        ...
        state._fsp--;
          ...
          if (state.backtracking == 1) {
              if (_first_0 == null) {
                  _first_0 = scalarVectorMult1.tree;
              }
          }
    ...
    try {
      ...
      // Simplify.g:16:20: ^( '*' INT ^( VEC (e+= . )+ ) )
      {
        _last = (CommonTree) input.LT(1);
        {
          ...
          _last = (CommonTree) input.LT(1);
          char_literal4 = (CommonTree) match(input, MULT, FOLLOW_MULT_in_scalarVectorMult127);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 1) {
                stream_MULT.add(char_literal4);
            }
          ...
          _last = (CommonTree) input.LT(1);
          INT5 = (CommonTree) match(input, INT, FOLLOW_INT_in_scalarVectorMult129);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 1) {
          ...
          _last = (CommonTree) input.LT(1);
          {
            ...
            _last = (CommonTree) input.LT(1);
            VEC6 = (CommonTree) match(input, VEC, FOLLOW_VEC_in_scalarVectorMult132);
              if (state.failed) {
                  return retval;
              }
              if (state.backtracking == 1) {
    ...
    try {
      ...
      // Simplify.g:20:9: ^( '*' a= INT b= INT {...}?)
      {
        _last = (CommonTree) input.LT(1);
        {
          ...
          CommonTree _first_1 = null;
          _last = (CommonTree) input.LT(1);
          char_literal7 = (CommonTree) match(input, MULT, FOLLOW_MULT_in_zeroX169);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 1) {
                stream_MULT.add(char_literal7);
            }

            if (state.backtracking == 1) {
                if (_first_0 == null) {
                    _first_0 = char_literal7;
                }
            }
          match(input, Token.DOWN, null);
            if (state.failed) {
          ...
          _last = (CommonTree) input.LT(1);
          a = (CommonTree) match(input, INT, FOLLOW_INT_in_zeroX173);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 1) {
          ...
          _last = (CommonTree) input.LT(1);
          b = (CommonTree) match(input, INT, FOLLOW_INT_in_zeroX177);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 1) {
    ...
    try {
      ...
      // Simplify.g:21:9: ^( '*' a= INT b= INT {...}?)
      {
        _last = (CommonTree) input.LT(1);
        {
          ...
          CommonTree _first_1 = null;
          _last = (CommonTree) input.LT(1);
          char_literal8 = (CommonTree) match(input, MULT, FOLLOW_MULT_in_xZero195);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 1) {
                stream_MULT.add(char_literal8);
            }

            if (state.backtracking == 1) {
                if (_first_0 == null) {
                    _first_0 = char_literal8;
                }
            }
          match(input, Token.DOWN, null);
            if (state.failed) {
          ...
          _last = (CommonTree) input.LT(1);
          a = (CommonTree) match(input, INT, FOLLOW_INT_in_xZero199);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 1) {
          ...
          _last = (CommonTree) input.LT(1);
          b = (CommonTree) match(input, INT, FOLLOW_INT_in_xZero203);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 1) {
  ...
  public static final BitSet FOLLOW_scalarVectorMult_in_topdown103 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_zeroX_in_bottomup111 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_xZero_in_bottomup115 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_MULT_in_scalarVectorMult127 = new BitSet(
      new long[]{0x0000000000000004L});
  public static final BitSet FOLLOW_INT_in_scalarVectorMult129 = new BitSet(
      new long[]{0x0000000000000040L});
  public static final BitSet FOLLOW_VEC_in_scalarVectorMult132 = new BitSet(
      new long[]{0x0000000000000004L});
  ...
  public static final BitSet FOLLOW_zeroX_in_synpred1_Simplify111 = new BitSet(
      new long[]{0x0000000000000002L});
