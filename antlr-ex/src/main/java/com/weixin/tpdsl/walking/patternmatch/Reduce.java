...
public class Reduce extends TreeRewriter {
  ...
  public static final String[] tokenNames = new String[]{
      "<invalid>", "<EOR>", "<DOWN>", "<UP>", "MULT", "SHIFT", "VEC", "ID", "INT", "WS", "'='",
      "'print'", "'+'", "'.'", "'['", "','", "']'", "'('", "')'"
  };
          ...
          // Reduce.g:12:8: xPlusx
        {
          ...
          state._fsp--;
            ...
            if (state.backtracking == 1) {
                if (_first_0 == null) {
                    _first_0 = xPlusx1.tree;
                }
            }

          if (state.backtracking == 1) {
            retval.tree = (CommonTree) _first_0;
              if (adaptor.getParent(retval.tree) != null && adaptor
    ...
    try {
      ...
      // Reduce.g:20:10: ^( '+' i= INT j= INT {...}?)
      {
        _last = (CommonTree) input.LT(1);
        {
          ...
          _last = (CommonTree) input.LT(1);
          char_literal4 = (CommonTree) match(input, 12, FOLLOW_12_in_xPlusx144);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 1) {
          ...
          _last = (CommonTree) input.LT(1);
          i = (CommonTree) match(input, INT, FOLLOW_INT_in_xPlusx148);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 1) {
          ...
          _last = (CommonTree) input.LT(1);
          j = (CommonTree) match(input, INT, FOLLOW_INT_in_xPlusx152);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 1) {
          ...
          if (!(((i != null ? Integer.valueOf(i.getText()) : 0) == (j != null ? Integer
              .valueOf(j.getText()) : 0)))) {
            if (state.backtracking > 0) {
              state.failed = true;
              return retval;
          ...
          // 20:47: -> ^( MULT[\"*\"] INT[\"2\"] $j)
          {
            // Reduce.g:20:50: ^( MULT[\"*\"] INT[\"2\"] $j)
            {
              ...
              root_1 = (CommonTree) adaptor
                  .becomeRoot((CommonTree) adaptor.create(MULT, "*"), root_1);
      ...
      switch (alt2) {
          ...
          // Reduce.g:26:9: ^( '*' x= INT {...}?y= . )
        {
          _last = (CommonTree) input.LT(1);
          {
            ...
            CommonTree _first_1 = null;
            _last = (CommonTree) input.LT(1);
            char_literal5 = (CommonTree) match(input, MULT, FOLLOW_MULT_in_multBy2187);
              if (state.failed) {
                  return retval;
              }
              if (state.backtracking == 1) {
                  stream_MULT.add(char_literal5);
              }

              if (state.backtracking == 1) {
                  if (_first_0 == null) {
                      _first_0 = char_literal5;
                  }
              }
            match(input, Token.DOWN, null);
              if (state.failed) {
            ...
            _last = (CommonTree) input.LT(1);
            x = (CommonTree) match(input, INT, FOLLOW_INT_in_multBy2191);
              if (state.failed) {
                  return retval;
              }
              if (state.backtracking == 1) {
          ...
          if (state.backtracking == 1) {
            retval.tree = root_0;
            RewriteRuleSubtreeStream stream_y = new RewriteRuleSubtreeStream(adaptor, "wildcard y",
                y);
            RewriteRuleSubtreeStream stream_retval = new RewriteRuleSubtreeStream(adaptor,
                "rule retval", retval != null ? retval.tree : null);
            ...
            // 26:39: -> ^( SHIFT[\"<<\"] $y INT[\"1\"] )
            {
              // Reduce.g:26:42: ^( SHIFT[\"<<\"] $y INT[\"1\"] )
              {
                CommonTree root_1 = (CommonTree) adaptor.nil();
                root_1 = (CommonTree) adaptor
                    .becomeRoot((CommonTree) adaptor.create(SHIFT, "<<"), root_1);
          ...
          // Reduce.g:27:9: ^( '*' a= . b= INT {...}?)
        {
          _last = (CommonTree) input.LT(1);
          {
            ...
            CommonTree _first_1 = null;
            _last = (CommonTree) input.LT(1);
            char_literal6 = (CommonTree) match(input, MULT, FOLLOW_MULT_in_multBy2222);
              if (state.failed) {
                  return retval;
              }
              if (state.backtracking == 1) {
                  stream_MULT.add(char_literal6);
              }

              if (state.backtracking == 1) {
                  if (_first_0 == null) {
                      _first_0 = char_literal6;
                  }
              }
            match(input, Token.DOWN, null);
              if (state.failed) {
            ...
            _last = (CommonTree) input.LT(1);
            b = (CommonTree) match(input, INT, FOLLOW_INT_in_multBy2230);
              if (state.failed) {
                  return retval;
              }
              if (state.backtracking == 1) {
          ...
          if (state.backtracking == 1) {
            retval.tree = root_0;
            RewriteRuleSubtreeStream stream_a = new RewriteRuleSubtreeStream(adaptor, "wildcard a",
                a);
            RewriteRuleSubtreeStream stream_retval = new RewriteRuleSubtreeStream(adaptor,
                "rule retval", retval != null ? retval.tree : null);
    ...
    try {
      ...
      // Reduce.g:33:8: ^( SHIFT ^( SHIFT e= . n= INT ) m= INT )
      {
        _last = (CommonTree) input.LT(1);
        {
          ...
          CommonTree _first_1 = null;
          _last = (CommonTree) input.LT(1);
          SHIFT7 = (CommonTree) match(input, SHIFT, FOLLOW_SHIFT_in_combineShifts268);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 1) {
                stream_SHIFT.add(SHIFT7);
            }
          ...
          _last = (CommonTree) input.LT(1);
          {
            ...
            _last = (CommonTree) input.LT(1);
            SHIFT8 = (CommonTree) match(input, SHIFT, FOLLOW_SHIFT_in_combineShifts271);
              if (state.failed) {
                  return retval;
              }
              if (state.backtracking == 1) {
                  stream_SHIFT.add(SHIFT8);
              }
            ...
            _last = (CommonTree) input.LT(1);
            n = (CommonTree) match(input, INT, FOLLOW_INT_in_combineShifts279);
              if (state.failed) {
                  return retval;
              }
              if (state.backtracking == 1) {
          ...
          _last = (CommonTree) input.LT(1);
          m = (CommonTree) match(input, INT, FOLLOW_INT_in_combineShifts284);
            if (state.failed) {
                return retval;
            }
            if (state.backtracking == 1) {
        ...
        if (state.backtracking == 1) {
          retval.tree = root_0;
          RewriteRuleSubtreeStream stream_e = new RewriteRuleSubtreeStream(adaptor, "wildcard e",
              e);
          RewriteRuleSubtreeStream stream_retval = new RewriteRuleSubtreeStream(adaptor,
              "rule retval", retval != null ? retval.tree : null);
          ...
          // 34:8: -> ^( SHIFT[\"<<\"] $e INT[String.valueOf($n.int+$m.int)] )
          {
            // Reduce.g:34:11: ^( SHIFT[\"<<\"] $e INT[String.valueOf($n.int+$m.int)] )
            {
              ...
              adaptor.addChild(root_1, (CommonTree) adaptor.create(INT, String.valueOf(
                  (n != null ? Integer.valueOf(n.getText()) : 0) + (m != null ? Integer
                      .valueOf(m.getText()) : 0))));
  ...
  public final void synpred3_Reduce_fragment() throws RecognitionException {
    ...
    // Reduce.g:26:9: ^( '*' x= INT {...}?y= . )
    {
      match(input, MULT, FOLLOW_MULT_in_synpred3_Reduce187);
        if (state.failed) {
            return;
        }
      ...
      x = (CommonTree) match(input, INT, FOLLOW_INT_in_synpred3_Reduce191);
        if (state.failed) {
            return;
        }
      if (!(((x != null ? Integer.valueOf(x.getText()) : 0) == 2))) {
  ...
  public static final BitSet FOLLOW_xPlusx_in_bottomup109 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_multBy2_in_bottomup118 = new BitSet(
      new long[]{0x0000000000000002L});
  public static final BitSet FOLLOW_combineShifts_in_bottomup127 = new BitSet(
      new long[]{0x0000000000000002L});
  ...
  public static final BitSet FOLLOW_MULT_in_multBy2187 = new BitSet(
      new long[]{0x0000000000000004L});
  public static final BitSet FOLLOW_INT_in_multBy2191 = new BitSet(new long[]{0x000000000007FFF0L});
  public static final BitSet FOLLOW_MULT_in_multBy2222 = new BitSet(
      new long[]{0x0000000000000004L});
  public static final BitSet FOLLOW_INT_in_multBy2230 = new BitSet(new long[]{0x0000000000000008L});
  public static final BitSet FOLLOW_SHIFT_in_combineShifts268 = new BitSet(
      new long[]{0x0000000000000004L});
  public static final BitSet FOLLOW_SHIFT_in_combineShifts271 = new BitSet(
      new long[]{0x0000000000000004L});
  public static final BitSet FOLLOW_INT_in_combineShifts279 = new BitSet(
      new long[]{0x0000000000000008L});
  public static final BitSet FOLLOW_INT_in_combineShifts284 = new BitSet(
      new long[]{0x0000000000000008L});
  public static final BitSet FOLLOW_MULT_in_synpred3_Reduce187 = new BitSet(
      new long[]{0x0000000000000004L});
  public static final BitSet FOLLOW_INT_in_synpred3_Reduce191 = new BitSet(
      new long[]{0x000000000007FFF0L});
