...
class ObjectOrientedTypesTestTest {
  ...
  @Test
  public void objectOrientedTypesTest1() throws IOException, RecognitionException {
    CharStream input = new ANTLRInputStream(
        getClass().getClassLoader().getResourceAsStream("oou.cymbol"));
  ...
  @Test
  public void objectOrientedTypesTest3() throws IOException, RecognitionException {
    CharStream input = new ANTLRInputStream(
        getClass().getClassLoader().getResourceAsStream("oow.cymbol"));
    CymbolLexer lex = new CymbolLexer(input);
    final TokenRewriteStream tokens = new TokenRewriteStream(lex);
    CymbolParser p = new CymbolParser(tokens);
    p.setTreeAdaptor(CymbolAdaptor);
