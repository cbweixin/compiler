...
class PromotionTypesTest {
  ...
  @Test
  public void testTypePromotion1() throws RecognitionException, IOException {
    CharStream input = new ANTLRInputStream(
        getClass().getClassLoader().getResourceAsStream("promotion_types_1.cymbol"));
...
//    System.out.println(dot.toDOT(t));
  ...
  @Test
  public void testTypePromotion2() throws RecognitionException, IOException {
    CharStream input = new ANTLRInputStream(
        getClass().getClassLoader().getResourceAsStream("promotion_types_2.cymbol"));
    CymbolLexer lex = new CymbolLexer(input);
    final TokenRewriteStream tokens = new TokenRewriteStream(lex);
    CymbolParser p = new CymbolParser(tokens);
    p.setTreeAdaptor(CymbolAdaptor);
